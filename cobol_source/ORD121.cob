      ...
      *  PROGRAMERT.: 29.11.96                                        *
      *  SIST RETTET: 19.10.98                                        *
      *                                                               *
      *  PROGRAMMET LISTER UT ALLE ORDRE MED KREDITT-STOPP.           *
      * 29.02.97  PRINTER LAGERKODE OG FINNER UT HVILKEN PRINTER.     *
      * 19.10.98  TATT I BRUK 8 SIFFERET DATO VIA SUBRUT: DATO8SIF    *
      ******************************************************************
      *
      ...
      ******** HAR ORDREN KREDITT STOPP  ***************
           ...
           IF  (I-01)
               ...
               END-IF
      *****************************************************************
      *   RUTINE FOR LAGER OG PRINTERIDENT:                           *
      *****************************************************************
           END-IF
           IF  (I-01)
               ...
               MOVE '    '                 TO PRINTR
           END-IF
           IF  (I-01 AND I-69 AND I-61)
               MOVE 'OSP1'                 TO PRINTR
           END-IF
           IF  (I-01 AND I-69 AND I-63)
               MOVE 'SCPO'                 TO PRINTR
      ...
      **********************************************
       ...
       HEADING-OUTPUT-P.
           IF  (I-L2 AND I-31 AND NOT-I-86)
               ...
               MOVE '* * *  ORDRE MED KREDITT' TO LISTE-IO-AREA (32:24)
               MOVE '-STOPP                ' TO LISTE-IO-AREA (57:22)
       ...
       TOTAL-OUTPUT-P.
           IF  (I-L1 AND I-30 AND NOT-I-86)
               ...
               MOVE 'LAGERKODE'            TO LISTE-IO-AREA (12:9)
               MOVE LAGER                  TO LISTE-IO-AREA (22:2)
               MOVE 'ORDREPRINTER'         TO LISTE-IO-AREA (25:12)
               MOVE PRINTR                 TO LISTE-IO-AREA (38:4)
               MOVE 'NETTO ORDRETOTAL.'    TO LISTE-IO-AREA (44:17)
               MOVE ORDTOT                 TO XO-72YY9R
               MOVE XO-72YY9R              TO LISTE-IO-AREA (64:13)
               INITIALIZE ORDTOT
               IF  (I-39)
                   MOVE '* ORDREN ER IKKE PRINTET' TO LISTE-IO-AREA
                                                               (78:24)
               END-IF
               IF  (NOT-I-39)
                   MOVE '  ORDREN ER PRINTET     ' TO LISTE-IO-AREA
                                                               (78:24)
               END-IF
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           ...
           IF  (I-L2 AND I-37 AND NOT-I-86)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'NETTO FIRMATOTAL '    TO LISTE-IO-AREA (14:17)
               MOVE FIRTOT                 TO XO-82YY9R
               MOVE XO-82YY9R              TO LISTE-IO-AREA (33:14)
               INITIALIZE FIRTOT
               MOVE 'ANTALL ORDRE.'        TO LISTE-IO-AREA (50:13)
               MOVE ANTORD                 TO XO-50YY9
               MOVE XO-50YY9               TO LISTE-IO-AREA (64:6)
               INITIALIZE ANTORD
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF.
