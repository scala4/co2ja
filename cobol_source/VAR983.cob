      ...
      **********************************************  Z-WIN-RPG2   ****
      * PROGRAM...VAR983                                              *
      * OPPDATERER LEVR.PRIS OG RAB. FRA GIVER TIL MOTTAGER DER DETTE *
      * IKKE ER LIKT.                                                 *
      * 24.04.01. UPSI 1 OVERFØRER OGSÅ SELVKOSTPRIS FRA LEVERANDØR.  *
      * 24.04.01. UPSI 2 OPPDATERER IKKE VARE.MASTER (TEST).          *
      * 23.01.02. UPSI 3 OPPDATERER IKKE LEVERANDØR RABATT.           *
      * 23.01.02. UPSI 4 OPPDATERER KARONGINNHOLD                *
      * 05.04.13. UPSI 5 OPPDATERER VALUTA                       *
      *****************************************************************
      *
      ...
      *
       ...
       01  WORK-AREA-BATCH.
           ...
           05  INNPUT-DATA-FIELDS.
               ...
               10  KPRIS-IO.
                   15  KPRIS               PICTURE S9(7)V9(2).
               10  UPRIS-IO.
                   15  UPRIS               PICTURE S9(7)V9(2).
               10  GKINNH-IO.
                   15  GKINNH              PICTURE S9(5) USAGE
                                                       PACKED-DECIMAL.
               10  GMLRAB-IO.
      ...
      *
           ...
           IF  (I-02)
               SET I-91                    TO TRUE
               ADD RABA TO ZERO        GIVING RAB
               ADD LEVP TO ZERO        GIVING PRIS
               GO TO SLUTT-T
      *
           END-IF
      ...
      *
       ...
       LEVRA-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE LEVRA-IO-AREA (66:9)   TO LKPRIS-IO
               INSPECT LKPRIS-IO REPLACING ALL ' ' BY '0'
               IF  LKPRIS = ZERO
                   SET I-08                TO TRUE
               END-IF
               MOVE LEVRA-IO-AREA (108:3)  TO KINNH-IO
               MOVE LEVRA-IO-AREA (153:2)  TO RABA-IO
               MOVE LEVRA-IO-AREA (165:5)  TO LEVP-IO
               IF  LEVP = ZERO
                   SET I-07                TO TRUE
               END-IF
               MOVE LEVRA-IO-AREA (170:1)  TO VALUTA (1:1)
               IF  VALUTA = SPACES
                   SET I-09                TO TRUE
               END-IF
           END-EVALUATE.
       ...
       INNPUT-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE INNPUT-IO-AREA (66:9)  TO KPRIS-IO
               INSPECT KPRIS-IO REPLACING ALL ' ' BY '0'
               MOVE INNPUT-IO-AREA (75:9)  TO UPRIS-IO
               INSPECT UPRIS-IO REPLACING ALL ' ' BY '0'
               MOVE INNPUT-IO-AREA (108:3) TO GKINNH-IO
       ...
       DETAIL-OUTPUT-P.
           IF  (I-03 AND I-25 AND NOT-I-U2)
               IF  (I-U1 AND NOT-I-08)
                   MOVE LKPRIS-IO          TO VAREMAS-IO-AREA (66:9)
               END-IF
               IF  (I-U1 AND I-24)
                   MOVE LKPRIS-IO          TO VAREMAS-IO-AREA (66:9)
               END-IF
               IF  (I-U4 AND NOT-I-07)
                   MOVE KINNH              TO XO-50P
                   MOVE XO-50P-EF          TO VAREMAS-IO-AREA (108:3)
               END-IF
               IF  (NOT-I-U3 AND NOT-I-07)
                   MOVE RABA               TO XO-21P
               ...
               END-IF
               IF  (I-U5 AND NOT-I-09)
                   MOVE VALUTA             TO VAREMAS-IO-AREA (170:1)
               END-IF
           ...
           IF  (I-1P)
               ...
               MOVE 'GML.'                 TO LISTE-IO-AREA (57:4)
               MOVE 'GML.'                 TO LISTE-IO-AREA (67:4)
               IF  (I-U1)
                   MOVE 'GML.KPRIS'        TO LISTE-IO-AREA (75:9)
               END-IF
               IF  (I-U1)
                   MOVE ' NY.KPRIS'        TO LISTE-IO-AREA (88:9)
               END-IF
               IF  (I-U1)
                   MOVE 'UTS.PRIS'         TO LISTE-IO-AREA (102:8)
               END-IF
               IF  (I-U4)
                   MOVE 'KART.INNHOLD'     TO LISTE-IO-AREA (109:12)
               END-IF
               IF  (I-U4)
                   MOVE 'UTS.PRIS'         TO LISTE-IO-AREA (102:8)
               END-IF
           ...
           IF  (I-03 AND I-25)
               ...
               IF  (NOT-I-U3)
                   MOVE RAB                TO XO-21YNZ
                   MOVE XO-21YNZ           TO LISTE-IO-AREA (39:4)
               END-IF
               MOVE PRIS                   TO XO-72YNZ
               MOVE XO-72YNZ               TO LISTE-IO-AREA (46:10)
               IF  (NOT-I-U3)
                   MOVE GMLRAB             TO XO-21YNZ
                   MOVE XO-21YNZ           TO LISTE-IO-AREA (57:4)
               END-IF
               MOVE GMLLEV                 TO XO-72YNZ
               MOVE XO-72YNZ               TO LISTE-IO-AREA (61:10)
               IF  (I-U1)
                   MOVE KPRIS              TO XO-72YY9
                   MOVE XO-72YY9           TO LISTE-IO-AREA (72:12)
               END-IF
               IF  (I-U1 AND NOT-I-08)
                   MOVE LKPRIS             TO XO-72YY9
                   MOVE XO-72YY9           TO LISTE-IO-AREA (85:12)
               END-IF
               IF  (I-U1 AND I-24)
                   MOVE LKPRIS             TO XO-72YY9
                   MOVE XO-72YY9           TO LISTE-IO-AREA (85:12)
               ...
               IF  (I-U1)
                   ...
                   MOVE XO-72YY9           TO LISTE-IO-AREA (98:12)
               END-IF
               IF  (I-U4)
                   MOVE KINNH              TO XO-50YY9
                   MOVE XO-50YY9           TO LISTE-IO-AREA (110:6)
               END-IF
               IF  (I-U4)
                   MOVE GKINNH             TO XO-50YY9
                   MOVE XO-50YY9           TO LISTE-IO-AREA (118:6)
               END-IF
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF.
       ...
       TOTAL-OUTPUT-P.
           IF  (I-LR)
               ...
               MOVE XO-60YY9               TO LISTE-IO-AREA (4:7)
               MOVE 'ANT.VAREREC. OPPDATERT  ' TO LISTE-IO-AREA (12:24)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF.
