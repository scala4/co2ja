      ...
      **********************************************  Z-WIN-RPG2   ****
      * PROGRAM   PRI998                                              *
      * REORGANISERING MED SLETTING PÅ VEIL.PRIS.MASTER               *
      *****************************************************************
      *
      ...
      *
       ...
       FILE-CONTROL.
           ...
           SELECT VEILMAS
               ...
               STATUS IS VEILMAS-STATUS
               RECORD KEY IS VEILMAS-KEY1.
           SELECT VAREMAS
               ASSIGN TO VAREMAS
       ...
       FD VEILMAS
               RECORD CONTAINS 40.
       01  VEILMAS-IO-AREA.
           05  VEILMAS-IO-AREA-X.
               10  VEILMAS-KEY1.
                   15  VEILMAS-KEY1N       PICTURE S9(13).
      ...
      * **START RBS - DATASTRUKTUR FOR SUB-PROGRAM RBS000 ********
       ...
       01  FILE-STATUS-TABLE.
           ...
           10  VEILMAS-STATUS              PICTURE 99 VALUE 0.
       ...
       01  WORK-AREA-BATCH.
           ...
           05  VEILMAS-KEY-NUM             PICTURE 9 VALUE 1 BINARY.
           05  FILLER                      PIC X VALUE '0'.
               88  VEILMAS-EOF-OFF         VALUE '0'.
               88  VEILMAS-EOF             VALUE '1'.
           05  FILLER                      PIC X VALUE '0'.
               88  VEILMAS-READ-OFF        VALUE '0'.
               88  VEILMAS-READ            VALUE '1'.
           05  FILLER                      PIC X VALUE '0'.
               88  VEILMAS-PROCESS-OFF     VALUE '0'.
               88  VEILMAS-PROCESS         VALUE '1'.
           05  FILLER                      PIC X VALUE '1'.
               88  VEILMAS-LEVEL-INIT-OFF  VALUE '0'.
               88  VEILMAS-LEVEL-INIT      VALUE '1'.
      ...
      **************************************************************
           05  VEILMAS-LEVEL-01.
               10  VEILMAS-01-L2.
                   15  VEILMAS-01-L2-FIRMA PICTURE X(3).
               10  VEILMAS-01-L1.
                   15  VEILMAS-01-L1-EDBNR PICTURE S9(7) USAGE
                                                       PACKED-DECIMAL.
           05  VEILMAS-DATA-FIELDS.
               10  REC                     PICTURE X(40).
      ...
      **************************************************************
       ...
       MAINLINE-LOOP.
           ...
           IF  VEILMAS-PROCESS
               SET VEILMAS-PROCESS-OFF     TO TRUE
               SET VEILMAS-READ            TO TRUE
           END-IF
 
           IF  VEILMAS-READ
           AND RECORD-SELECTED-OFF
               PERFORM VEILMAS-GET
               SET VEILMAS-READ-OFF        TO TRUE
               IF  NOT VEILMAS-EOF
                   SET VEILMAS-PROCESS     TO TRUE
                   SET RECORD-SELECTED     TO TRUE
               END-IF
           END-IF
           ...
           IF  VEILMAS-PROCESS
               PERFORM VEILMAS-IDSET
           END-IF
 
           IF  VEILMAS-PROCESS
               PERFORM VEILMAS-CHK-LEVEL
           END-IF
      ...
      *****************************************************************
       ...
       PRTRUT-T.
           ...
           IF  (I-01)
               ...
               ADD PRIS TO ZERO        GIVING VEIPRI
      *
           END-IF
           .
      ...
      ******************************************************
       ...
       VEILMAS-GET-P.
           IF  VEILMAS-EOF-OFF
               READ VEILMAS
               AT END
                   SET VEILMAS-EOF         TO TRUE
                   SUBTRACT 1            FROM LR-CHECK
               END-READ
           END-IF.
 
       VEILMAS-FLDSET SECTION.
       VEILMAS-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE VEILMAS-IO-AREA (1:40) TO REC (1:40)
               MOVE VEILMAS-IO-AREA (1:3)  TO FIRMA (1:3)
               MOVE VEILMAS-IO-AREA (4:4)  TO EDBNR-IO
               MOVE VEILMAS-IO-AREA (8:6)  TO KNR (1:6)
               MOVE VEILMAS-IO-AREA (14:4) TO FRAD-IO
               MOVE VEILMAS-IO-AREA (18:4) TO TILD-IO
               MOVE VEILMAS-IO-AREA (22:5) TO PRIS-IO
           END-EVALUATE.
 
       VEILMAS-IDSET SECTION.
       VEILMAS-IDSET-P.
           SET I-01                        TO TRUE.
 
       VEILMAS-CHK-LEVEL SECTION.
       VEILMAS-CHK-LEVEL-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE LOW-VALUES             TO VEILMAS-LEVEL-01
               MOVE VEILMAS-IO-AREA (1:3)  TO VEILMAS-01-L2-FIRMA
               MOVE VEILMAS-IO-AREA (4:4)  TO VEILMAS-01-L1-EDBNR
               IF  VEILMAS-LEVEL-INIT
                   EVALUATE TRUE
                   WHEN  VEILMAS-01-L2 NOT = THE-PRIOR-L2
                       PERFORM SETON-I-L2
                   WHEN  VEILMAS-01-L1 NOT = THE-PRIOR-L1
                       PERFORM SETON-I-L1
                   END-EVALUATE
               END-IF
               MOVE  VEILMAS-01-L2         TO THE-PRIOR-L2
               MOVE  VEILMAS-01-L1         TO THE-PRIOR-L1
               SET VEILMAS-LEVEL-INIT      TO TRUE
           END-EVALUATE.
       ...
       INITIALIZATION-P.
           ...
           OPEN INPUT PARAM
           SET VEILMAS-LEVEL-INIT          TO TRUE
           INITIALIZE VEILMAS-DATA-FIELDS
           SET VEILMAS-EOF-OFF             TO TRUE
           SET VEILMAS-PROCESS             TO TRUE
           OPEN INPUT VEILMAS
