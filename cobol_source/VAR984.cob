       ...
       PROGRAM-ID. VAR984R.
      **********************************************  Z-WIN-RPG2   ****
      * PROGRAM: VAR984  ENDRER MÅNED OG ÅR I ARTNUM   I VARE.MASTER  *
      *  14/10-02 PROGRAMMERT AV STEIN SANDVOLD                       *
      *****************************************************************
      *
      ...
      *
       ...
       DETAIL-CALCS-P.
           ...
           ADD 1                           TO ANTLES
      *****************************************************************
      * OPPSLAG MOT VARE.MASTER OPPDATERE ART.NUMMER                  *
      *****************************************************************
       ...
       MNDPAR-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE MNDPAR-IO-AREA (3:4)   TO AAR-IO
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01 AND I-31)
               MOVE MND3F                  TO VAREMAS-IO-AREA (25:3)
               MOVE AAR-IO                 TO VAREMAS-IO-AREA (29:4)
           ...
           IF  (I-1P)
               ...
               MOVE 'ENDRING ARRNR   '     TO LISTE-IO-AREA (13:16)
           ...
           IF  (I-01)
               ...
               MOVE ARTNR                  TO LISTE-IO-AREA (23:20)
               MOVE ARTNR                  TO LISTE-IO-AREA (56:20)
               MOVE MND3F                  TO LISTE-IO-AREA (65:3)
               MOVE AAR-IO                 TO LISTE-IO-AREA (69:4)
               IF  (NOT-I-31)
                   MOVE 'UKJENT VARE.'     TO LISTE-IO-AREA (89:12)
               END-IF
               IF  (I-31)
                   MOVE 'OPPDATERT OK'     TO LISTE-IO-AREA (89:12)
               END-IF
               IF  (I-70)
                   MOVE '70'               TO LISTE-IO-AREA (101:2)
               END-IF
               IF  (I-71)
                   MOVE '71'               TO LISTE-IO-AREA (103:2)
               END-IF
               IF  (I-72)
                   MOVE '72'               TO LISTE-IO-AREA (105:2)
               END-IF
               IF  (I-73)
                   MOVE '73'               TO LISTE-IO-AREA (107:2)
               END-IF
               IF  (I-74)
                   MOVE '74'               TO LISTE-IO-AREA (109:2)
               END-IF
               IF  (I-75)
                   MOVE '75'               TO LISTE-IO-AREA (111:2)
               END-IF
               IF  (I-76)
                   MOVE '76'               TO LISTE-IO-AREA (113:2)
               END-IF
               IF  (I-77)
                   MOVE '77'               TO LISTE-IO-AREA (115:2)
               END-IF
               IF  (I-78)
                   MOVE '78'               TO LISTE-IO-AREA (117:2)
               END-IF
               IF  (I-79)
                   MOVE '79'               TO LISTE-IO-AREA (119:2)
               END-IF
               IF  (I-80)
                   MOVE '80'               TO LISTE-IO-AREA (121:2)
               END-IF
               IF  (I-81)
                   MOVE '81'               TO LISTE-IO-AREA (123:2)
               END-IF
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF.
