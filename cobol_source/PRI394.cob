       ...
       PROGRAM-ID. PRI394R.
      **********************************************  Z-WIN-RPG2   ****
      **DANNING AV PRISREC MED TILLEGGSFILE                              **
      *********************************************************************
      *
      ...
      *
       ...
       FD INNPUT
               ...
               RECORD CONTAINS 120.
       01  INNPUT-IO-AREA.
           05  INNPUT-IO-AREA-X            PICTURE X(120).
       FD VARETIL
               RECORD CONTAINS 200.
       01  VARETIL-IO-AREA.
      ...
      *
       ...
       INNPUT-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE INNPUT-IO-AREA (1:120) TO REC (1:120)
               MOVE INNPUT-IO-AREA (63:3)  TO FIRMA (1:3)
               MOVE INNPUT-IO-AREA (89:7)  TO EDBNR (1:7)
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               ...
               MOVE REC                    TO OUTPUT-X-IO-AREA (1:120)
               IF  (NOT-I-16)
                   MOVE EANK               TO OUTPUT-X-IO-AREA (96:14)
               END-IF
