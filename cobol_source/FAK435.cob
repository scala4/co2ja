      ...
      *  LEGGE INN FAKTURA-KUNDENR. SEQ.NR. AVD. BET.MÅTE.           *
      *  PERIODE = KASSEOPPGJØRSMÅNED OG ÅR.                         *
      *  ORDREDATO = KASSEOPPGJØRSDATO.                              *
      *  IKKE ORDREGEBYR.                                            *
      *  KREDITNOTA BLIR SATT SOM FAKTURA. (ORDRENR. SKILLER)        *
      * 15.02.94 ESPEN LARSEN                                        *
      * 31.05.94 KASSEOPPGJØRSDAG BLIR SATT INN BRUDD-KODE FOR       *
      *          SPLITTE OPPGJØR SOM TILHØRER FORSKJELLIGE DATO,     *
      *          SLIK ATT DISSE KOMMER PÅ HVER SIN FAKTURA.          *
      ****************************************************************
      *
