      ...
      *
       ...
       FD TRANS
               ...
               RECORD CONTAINS 200.
       01  TRANS-IO-AREA.
           05  TRANS-IO-AREA-X             PICTURE X(200).
       FD OUTPUT-X
               BLOCK CONTAINS 9400
               RECORD CONTAINS 200.
       01  OUTPUT-X-IO-AREA.
      ...
      *      RUTINE FOR OPPBYGGING AV OPPSLAGSNUMMER           *
       ...
       TRANS-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE TRANS-IO-AREA (16:20)  TO ARTNR (1:20)
               MOVE TRANS-IO-AREA (13:3)   TO ALFA (1:3)
               MOVE TRANS-IO-AREA (6:7)    TO EDBNR (1:7)
               MOVE TRANS-IO-AREA (1:200)  TO REC (1:200)
           END-EVALUATE.
