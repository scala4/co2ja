       ...
       PROGRAM-ID. VRG902R.
      **********************************************  Z-WIN-RPG2   ****
      *  DANNE TABELLER FOR KOPIERING AV VARETIL FRA FIRMA TIL FIRMA      *
      *********************************************************************
      *
      ...
      *
       ...
       01  WORK-AREA-BATCH.
           ...
           05  TEMPORARY-FIELDS.
               ...
               10  ANTL1T-IO.
                   15  ANTL1T              PICTURE S9(2).
               10  ANTL1M-IO.
                   15  ANTL1M              PICTURE S9(2).
               10  ANTL2-IO.
       ...
       KORTFIL-IDSET-P.
           ...
           WHEN ( KORTFIL-IO-AREA (80:1) = 'J' )
               SET I-01                    TO TRUE
           WHEN ( KORTFIL-IO-AREA (80:1) NOT = 'J' )
               SET I-02                    TO TRUE
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-1P)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'TABELLTOTALER VRG902' TO LISTE-IO-AREA (1:20)
       ...
       TOTAL-OUTPUT-P.
           IF  (I-L1)
               ...
               MOVE SEQ-IO                 TO TILFIL-IO-AREA (13:2)
           ...
           IF  (I-L2)
               ...
               MOVE ANT-IO                 TO FRAFIL-IO-AREA (13:2)
               INITIALIZE ANT-IO
           ...
           IF  (I-L3)
               ...
               MOVE '80'                   TO LIMFIL-IO-AREA (1:2)
               MOVE FRAFNR                 TO LIMFIL-IO-AREA (3:3)
               MOVE '0000001'              TO LIMFIL-IO-AREA (6:7)
               MOVE '80'                   TO LIMFIL-IO-AREA (13:2)
               MOVE FRAFNR                 TO LIMFIL-IO-AREA (15:3)
               MOVE '8999999'              TO LIMFIL-IO-AREA (18:7)
           ...
           IF  (I-LR)
               ...
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE ANTL1M                 TO XO-20YY9
               MOVE XO-20YY9               TO LISTE-IO-AREA (5:2)
