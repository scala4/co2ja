      ...
      *
       ...
       FD UTFILE
               ...
               RECORD CONTAINS 120.
       01  UTFILE-IO-AREA.
           05  UTFILE-IO-AREA-X            PICTURE X(120).
      ...
      * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
       ...
       INFILE-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE INFILE-IO-AREA (1:120) TO REC (1:120)
               MOVE INFILE-IO-AREA (5:20)  TO ARTNR (1:20)
               MOVE INFILE-IO-AREA (10:15) TO ART5 (1:15)
               IF  ART5 = SPACES
                   SET I-05                TO TRUE
               END-IF
               MOVE INFILE-IO-AREA (15:10) TO ART10 (1:10)
               IF  ART10 = SPACES
                   SET I-06                TO TRUE
               END-IF
               MOVE INFILE-IO-AREA (20:5)  TO ART15 (1:5)
               IF  ART15 = SPACES
                   SET I-07                TO TRUE
               END-IF
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               ...
               MOVE REC                    TO UTFILE-IO-AREA (1:120)
               MOVE 25                     TO BW-A
               PERFORM VARYING ARU-I FROM ARU-MAX BY -1
                         UNTIL ARU-I < 1
                   SUBTRACT 1            FROM BW-A
                   MOVE ARU-ENTRY (ARU-I)  TO UTFILE-IO-AREA (BW-A:1)
