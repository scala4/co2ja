      ...
      *
       ...
       01  SERFILE-IO-AREA-2.
           05  SERFILE-IO-AREA-X           PICTURE X(60).
       FD VAGRMAS
               RECORD CONTAINS 80.
       01  VAGRMAS-IO-AREA.
      ...
      * * END - RBS - DATASTRUKTUR FOR SUB-PROGRAM RBSH01 ********
           ...
           05  TEMPORARY-FIELDS.
               ...
               10  AVDBEL-IO.
                   15  AVDBEL              PICTURE S9(8)V9(2).
               10  TOTBEL-IO.
                   15  TOTBEL              PICTURE S9(8)V9(2).
               10  VGRREL-IO.
                   15  VGRREL              PICTURE S9(7)V9(2).
               10  AVDREL-IO.
                   15  AVDREL              PICTURE S9(8)V9(2).
               10  TOTREL-IO.
      ...
      ***
       ...
       TOTAL-CALCS-P.
           IF  (I-L0 AND I-86)
               GO TO L1END-T
      ***********************************************************
      *  SJEKKE OM L3-BRUDD ER AVDELINGSBRUDD PÅ AUTO-SUPPLY. ***
      ***********************************************************
           END-IF
           IF  (I-L2)
      ...
      ******************************************************
       ...
       SERFILE-FLDSET-P.
           EVALUATE TRUE
           WHEN ( SERFILE-IO-AREA (1:1) = '7'
            AND   SERFILE-IO-AREA (2:1) = '2' )
       ...
       HEADING-OUTPUT-P.
           ...
           OR  (I-L3 AND NOT-I-50 AND NOT-I-86)
               ...
               MOVE '* * * * *    S E R V I C' TO LISTE-IO-AREA (32:24)
               MOVE 'E P R O S E N T R A P P' TO LISTE-IO-AREA (57:23)
               MOVE 'O R T   F O R'        TO LISTE-IO-AREA (81:13)
               MOVE PMND                   TO LISTE-IO-AREA (96:9)
               MOVE PA-ELGR                TO LISTE-IO-AREA (107:4)
               MOVE '* * * * *'            TO LISTE-IO-AREA (115:9)
      ...
      *                     N50AVDNAV    44
               ...
               MOVE XO-31YY9R              TO LISTE-IO-AREA (81:6)
               INITIALIZE AVDSPR
               MOVE AVDBEL                 TO XO-82YY9R
               MOVE XO-82YY9R              TO LISTE-IO-AREA (89:14)
               INITIALIZE AVDBEL
               MOVE AVDREL                 TO XO-82YY9R
