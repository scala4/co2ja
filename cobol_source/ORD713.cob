       ...
       PROGRAM-ID. ORD713R.
      **********************************************  Z-WIN-RPG2   ****
      * DANNER I REST.RECORD FRA FASTE VARESETT.           *
      * PROGRAMMER: ESPEN LARSEN  12.11.2005               *
      *    KODE V = FASTE VARESETT.                        *
      *    KODE W = LØSE STRUKTURER.                       *
      * ENDRINGER                                          *
      * DATO    AV  BESKRIVELSE                            *
      * 121208  TOM HOPPER OVER SLETTEDE VARESETTLINJER    *
      ******************************************************
      *
      ...
      ******************************************************
       ...
       VARSTVS-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE VARSTVS-IO-AREA (16:7) TO ORDNR (1:7)
       ...
       VARSTVS-CHK-LEVEL-P.
           ...
           WHEN ANY
               ...
               MOVE VARSTVS-IO-AREA (1:3)  TO VARSTVS-01-L2-FIRMA
               MOVE VARSTVS-IO-AREA (4:7)  TO VARSTVS-01-L1-EDBSET
       ...
       VARESET-FLDSET-P.
           ...
           WHEN ( VARESET-IO-AREA (1:1) = 'A' )
               ...
               MOVE VARESET-IO-AREA (30:1) TO SLETT (1:1)
       ...
       EXCEPTION-OUTPUT-P.
           IF  (I-01 AND I-51)
               ...
               MOVE EDBVAR                 TO VARSTAA-IO-AREA (4:7)
           ...
           IF  (I-01 AND I-61 AND I-U1)
               ...
               MOVE ORDNR                  TO TOTALER-IO-AREA (4:7)
       ...
       HEADING-OUTPUT-P.
           IF  (I-1P AND I-U1)
               ...
               MOVE 'DANNE I REST.REC. FRA ' TO TOTALER-IO-AREA (13:22)
