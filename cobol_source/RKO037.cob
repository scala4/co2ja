       ...
       PROGRAM-ID. RKO037R.
      **********************************************  Z-WIN-RPG2   ****
      *  PROGRAM: RKO037, ENDRER RESK.NR I HHT TABELL                 *
      *  ENDR...:                                                     *
      *****************************************************************
      *
      ...
      *BUGFILO O   F  80  80            PRINTERSYSLST
       ...
       01  WORK-AREA-BATCH.
           ...
           05  GMLRESK-LEVEL-01.
               ...
               10  GMLRESK-01-L1.
                   15  GMLRESK-01-L1-RES1  PICTURE X(6).
      ...
      *
       ...
       GMLRESK-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE GMLRESK-IO-AREA (3:9)  TO FOK (1:9)
           END-EVALUATE.
       ...
       GMLRESK-CHK-LEVEL-P.
           ...
           WHEN ANY
               ...
               MOVE GMLRESK-IO-AREA (6:6)  TO GMLRESK-01-L1-RES1
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               ...
               IF  (I-10)
                   MOVE TABKTO (TABKTO-I)  TO OUTRESK-IO-AREA (6:6)
               END-IF
           ...
           IF  (I-01 AND I-10)
               ...
               MOVE REC1H                  TO LISTE-IO-AREA (1:100)
               IF  (I-10)
                   MOVE TABKTO (TABKTO-I)  TO LISTE-IO-AREA (6:6)
               END-IF
       ...
       HEADING-OUTPUT-P.
           IF  (I-1P)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'PROGRAM RKO037          ' TO LISTE-IO-AREA (1:24)
