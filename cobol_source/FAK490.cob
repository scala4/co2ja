      ...
      *                 ER LAGT INN I RBS1.                           *
      *  ENDR 21.02.12: SKRIVER FAKTUR2, 48 LINJER, KUN NÅR U1 ER PÅ  *
      ...
      ******************************************************
       ...
       DETAIL-OUTPUT-P.
           ...
           IF  (I-38 AND I-95)
               ...
               PERFORM FAKTUR1-PRINT-LINE
           END-IF
           IF  (I-71 AND NOT-I-95)
           OR  (I-39 AND NOT-I-95)
               MOVE SPACES TO FAKTUR2-IO-AREA
               INITIALIZE FAKTUR2-IO-AREA
           ...
           IF  (I-39 AND NOT-I-95)
               ...
               END-IF
           END-IF
           IF  (I-78 AND NOT-I-95)
           OR  (I-79 AND NOT-I-95)
           OR  (I-80 AND NOT-I-95)
           OR  (I-81 AND NOT-I-95)
           OR  (I-82 AND NOT-I-95)
           OR  (I-83 AND NOT-I-95)
           OR  (I-84 AND NOT-I-95)
           OR  (I-85 AND NOT-I-95)
           OR  (I-86 AND NOT-I-95)
               MOVE SPACES TO FAKTUR2-IO-AREA
               INITIALIZE FAKTUR2-IO-AREA
