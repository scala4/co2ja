      ...
      **********************************************  Z-WIN-RPG2   ****
      *  PROGRAM.......: RES506                                       *
      **  FJERNE AJOURHOLDSMERKET PÅ KUNDEARKIVET.                     * **
      *  KJØRES I JOBB.: DOP53B                                       *
      *********************************************************************
      *
      ...
      *
       ...
       KUNDEMA-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE KUNDEMA-IO-AREA (200:1) TO KODE (1:1)
               IF  KODE = SPACES
                   SET I-99                TO TRUE
               END-IF
           END-EVALUATE.
       ...
       TOTAL-OUTPUT-P.
           IF  (I-LR)
               ...
               INITIALIZE LISTE-IO-AREA
               IF  (I-U1)
                   MOVE 'ANTALL SELEKTERT' TO LISTE-IO-AREA (3:16)
               END-IF
               IF  (NOT-I-U1)
                   MOVE 'ANTALL KORRIGERT' TO LISTE-IO-AREA (3:16)
               END-IF
               MOVE ANT                    TO XO-90YY9
               MOVE XO-90YY9               TO LISTE-IO-AREA (20:11)
