      ...
      *
       ...
       FD VARE
               ...
               RECORD CONTAINS 100.
       01  VARE-IO-AREA.
           05  VARE-IO-AREA-X              PICTURE X(100).
       FD VAREUT
               BLOCK CONTAINS 9000
               RECORD CONTAINS 100.
       01  VAREUT-IO-AREA.
           05  VAREUT-IO-AREA-X            PICTURE X(100).
      ...
      * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
       ...
       VARE-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE VARE-IO-AREA (1:100)   TO REC (1:100)
               MOVE VARE-IO-AREA (14:20)   TO ARTNR (1:20)
               MOVE VARE-IO-AREA (19:15)   TO ART5 (1:15)
               IF  ART5 = SPACES
                   SET I-05                TO TRUE
               END-IF
               MOVE VARE-IO-AREA (24:10)   TO ART10 (1:10)
               IF  ART10 = SPACES
                   SET I-06                TO TRUE
               END-IF
               MOVE VARE-IO-AREA (29:5)    TO ART15 (1:5)
               IF  ART15 = SPACES
                   SET I-07                TO TRUE
               END-IF
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               ...
               MOVE REC                    TO VAREUT-IO-AREA (1:100)
               MOVE 34                     TO BW-A
