      ...
      *  RETTET.....: 07.03.02                                        *
      *                                                               *
      *  AKKUMULERT SLETTELISTE UT I FRA REORG AV REKLAMASJONSFILE    *
      *  07.03.02..- LAGT INN KONSERFIRMANUMMER FOR Å HENDTE KUNDENVN *
      *****************************************************************
      *
      ...
      *
       ...
       FD INNPUT
               ...
               RECORD CONTAINS 280.
       01  INNPUT-IO-AREA.
           05  INNPUT-IO-AREA-X            PICTURE X(280).
       FD FIRMAF
      ...
      * * END   RBS - PARAMETERKORT OVERSTYRING AV RBS-FILE  * *
           05  INNPUT-LEVEL-02.
               10  INNPUT-02-L3.
                   15  INNPUT-02-L3-FIRMA  PICTURE X(3).
               10  INNPUT-02-L2.
                   15  INNPUT-02-L2-KNR    PICTURE X(6).
           05  INNPUT-DATA-FIELDS.
               ...
               10  RAPNR-IO.
                   15  RAPNR               PICTURE S9(6).
               10  ORDNR-IO.
                   15  ORDNR               PICTURE S9(6).
               10  REGDAT-IO.
                   15  REGDAT              PICTURE S9(6).
               10  KORDAT-IO.
                   15  KORDAT              PICTURE S9(6).
               10  STATK                   PICTURE X(1).
               10  STATL                   PICTURE X(1).
               10  ARTNR                   PICTURE X(20).
               10  ALFA                    PICTURE X(3).
               10  REF                     PICTURE X(8).
               10  ARBP-IO.
                   15  ARBP                PICTURE S9(6)V9(2).
      ...
      ******************************************************
       ...
       INNPUT-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE INNPUT-IO-AREA (61:2)  TO MND-IO
               INSPECT MND-IO REPLACING ALL ' ' BY '0'
               MOVE INNPUT-IO-AREA (4:6)   TO REKNR (1:6)
               MOVE INNPUT-IO-AREA (14:6)  TO KNR (1:6)
               MOVE INNPUT-IO-AREA (29:6)  TO LEVNR (1:6)
               MOVE INNPUT-IO-AREA (41:6)  TO RAPNR-IO
               INSPECT RAPNR-IO REPLACING ALL ' ' BY '0'
               MOVE INNPUT-IO-AREA (47:6)  TO ORDNR-IO
               INSPECT ORDNR-IO REPLACING ALL ' ' BY '0'
               MOVE INNPUT-IO-AREA (53:6)  TO REGDAT-IO
               INSPECT REGDAT-IO REPLACING ALL ' ' BY '0'
               MOVE INNPUT-IO-AREA (59:6)  TO KORDAT-IO
               INSPECT KORDAT-IO REPLACING ALL ' ' BY '0'
               MOVE INNPUT-IO-AREA (65:1)  TO STATK (1:1)
               MOVE INNPUT-IO-AREA (66:1)  TO STATL (1:1)
               MOVE INNPUT-IO-AREA (81:20) TO ARTNR (1:20)
               MOVE INNPUT-IO-AREA (199:3) TO ALFA (1:3)
               MOVE INNPUT-IO-AREA (202:8) TO REF (1:8)
               MOVE INNPUT-IO-AREA (210:8) TO ARBP-IO
               INSPECT ARBP-IO REPLACING ALL ' ' BY '0'
               MOVE INNPUT-IO-AREA (231:50) TO TEKST (1:50)
           END-EVALUATE.
       ...
       INNPUT-CHK-LEVEL-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE LOW-VALUES             TO INNPUT-LEVEL-02
               MOVE INNPUT-IO-AREA (1:3)   TO INNPUT-02-L3-FIRMA
               MOVE INNPUT-IO-AREA (14:6)  TO INNPUT-02-L2-KNR
               IF  INNPUT-LEVEL-INIT
                   EVALUATE TRUE
                   WHEN  INNPUT-02-L3 NOT = THE-PRIOR-L3
                       PERFORM SETON-I-L3
                   WHEN  INNPUT-02-L2 NOT = THE-PRIOR-L2
                       PERFORM SETON-I-L2
                   END-EVALUATE
               END-IF
               MOVE  INNPUT-02-L3          TO THE-PRIOR-L3
               MOVE  INNPUT-02-L2          TO THE-PRIOR-L2
       ...
       FIRMAF-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE FIRMAF-IO-AREA (1:3)   TO FNR (1:3)
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-L2 AND NOT-I-86)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE KNR                    TO LISTE-IO-AREA (10:6)
               IF  (NOT-I-21)
                   MOVE NAVN1              TO LISTE-IO-AREA (17:30)
               END-IF
               IF  (NOT-I-21)
                   MOVE ADR                TO LISTE-IO-AREA (52:30)
               END-IF
               IF  (NOT-I-21)
                   MOVE PNR                TO LISTE-IO-AREA (83:4)
               END-IF
               IF  (NOT-I-21)
                   MOVE PSTED              TO LISTE-IO-AREA (88:15)
               END-IF
           ...
           IF  (I-02 AND NOT-I-86)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE REF                    TO LISTE-IO-AREA (1:8)
               MOVE ALFA                   TO LISTE-IO-AREA (19:3)
               MOVE ARTNR                  TO LISTE-IO-AREA (24:20)
               MOVE TEKST                  TO LISTE-IO-AREA (45:50)
               MOVE ORDNR-IO               TO LISTE-IO-AREA (97:6)
               MOVE RAPNR-IO               TO LISTE-IO-AREA (105:6)
               MOVE ARBP                   TO XO-62YY9R
               MOVE XO-62YY9R              TO LISTE-IO-AREA (112:11)
               MOVE REKNR                  TO LISTE-IO-AREA (124:6)
               MOVE STATK                  TO LISTE-IO-AREA (132:1)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF.
       ...
       HEADING-OUTPUT-P.
           IF  (I-L3 AND NOT-I-86)
               ...
               MOVE '* SLETTINGER AV REKLAMAS' TO LISTE-IO-AREA (47:24)
               MOVE 'JONER *     DATO '    TO LISTE-IO-AREA (71:17)
               ...
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'KUNDREF KUNDENR.'     TO LISTE-IO-AREA (2:16)
               MOVE 'ALFA ARTIKKEL'        TO LISTE-IO-AREA (19:13)
               MOVE 'FRI TEKST'            TO LISTE-IO-AREA (45:9)
               MOVE 'ORDRENR'              TO LISTE-IO-AREA (97:7)
               MOVE 'RAPPORT'              TO LISTE-IO-AREA (105:7)
               MOVE 'ARB.PENGER'           TO LISTE-IO-AREA (113:10)
               MOVE 'REKLNR.'              TO LISTE-IO-AREA (124:7)
               MOVE 'S'                    TO LISTE-IO-AREA (132:1)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
