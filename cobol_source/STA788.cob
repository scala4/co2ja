       ...
       PROGRAM-ID. STA788R.
      **********************************************  Z-WIN-RPG2   ****
      * 06.02.12 - Lagt inn konserfirma for å hente SELGERNR - EN    *
      *
      ...
      *
       ...
       01  WORK-AREA-BATCH.
           ...
           05  SALGF-LEVEL-01.
               10  SALGF-01-L1.
                   15  SALGF-01-L1-KNR     PICTURE X(6).
      ...
      *
       ...
       DETAIL-CALCS-P.
           ...
           IF  (NOT-I-61)
               ...
               END-IF
      *****************************************************************
      * OPPSLAG FOR Å FINNE KUNDEMX FOR KONSERN                       *
      *****************************************************************
           END-IF
           IF  (I-L1)
           ...
           END-IF
           IF  (I-L1 AND NOT-I-92 AND NOT-I-60)
               SET NOT-I-93                TO TRUE
               IF  KONFNR > '000'
                   SET I-93                TO TRUE
               END-IF
           END-IF
           IF  (I-L1 AND NOT-I-92 AND I-93)
               MOVE KONFNR                 TO KKEY (1:3)
           END-IF
           IF  (I-L1 AND NOT-I-60)
               MOVE KNR                    TO KKEY (4:6)
               MOVE KKEY                   TO KKEY1 (1:9)
               MOVE 1                      TO KKEY1 (10:1)
               MOVE KKEY1                  TO KUNDEMX-KEY1
           ...
           IF  (I-L1 AND NOT-I-28)
               ...
               MOVE SNR1                   TO SKEY (6:3)
           END-IF
           IF  (I-L1 AND NOT-I-28 AND I-60)
       ...
       SALGF-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE SALGF-IO-AREA (54:2)   TO HND2 (1:2)
       ...
       SALGF-CHK-LEVEL-P.
           ...
           WHEN ANY
               ...
               MOVE SALGF-IO-AREA (45:6)   TO SALGF-01-L1-KNR
               IF  SALGF-LEVEL-INIT
                   EVALUATE TRUE
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               ...
               IF  (NOT-I-60 AND NOT-I-28)
                   MOVE SNR1               TO OUTFIL-IO-AREA (108:3)
               END-IF
               IF  (I-60)
               ...
               END-IF
               IF  (I-61)
                   MOVE '000'              TO OUTFIL-IO-AREA (108:3)
               END-IF
               IF  (I-61)
                   MOVE '                    ' TO OUTFIL-IO-AREA
                                                              (111:20)
               END-IF
