      ...
      *  02N10   TOTANT    SUB  ANT       TOTANT
       ...
       KOPIINN-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE KOPIINN-IO-AREA (21:5) TO ANT-IO
               MOVE KOPIINN-IO-AREA (20:1) TO SIGN-X (1:1)
       ...
       TOTAL-OUTPUT-P.
           IF  (I-L1)
               ...
               MOVE TOTANT                 TO XO-92P
               MOVE XO-92P-EF              TO KOPIUT-IO-AREA (20:6)
