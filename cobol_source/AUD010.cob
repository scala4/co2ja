      ...
      *****************************************************************
       ...
       INNDATA-FLDSET-P.
           ...
           WHEN ( INNDATA-IO-AREA (1:1) NOT = ' ' )
               ...
               MOVE INNDATA-IO-AREA (46:30) TO NAVN (1:30)
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               ...
               END-IF
               MOVE NAVN                   TO LISTE2-IO-AREA (103:30)
           ...
           IF  (I-01 AND NOT-I-50)
               ...
               MOVE BEL-IO                 TO UTDATA-IO-AREA (63:8)
               MOVE NAVN                   TO UTDATA-IO-AREA (71:30)
       ...
       HEADING-OUTPUT-P.
           IF  (I-01 AND I-L2)
               ...
               MOVE 'DATA.  FAK399D'       TO LISTE2-IO-AREA (25:14)
               MOVE UDATE                  TO EDIT-DATE
       ...
       TOTAL-OUTPUT-P.
           ...
           IF  (I-L2)
               ...
               MOVE ANTLES                 TO XO-60YY9
               MOVE XO-60YY9               TO LISTE2-IO-AREA (60:7)
               IF  (I-50)
