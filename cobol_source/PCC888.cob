       ...
       PROGRAM-ID. PCC888R.
      **********************************************  Z-WIN-RPG2   ****
      * DETTE PROGRAM BRUKES XPCC20A     - MÅ IKKE SLETTES            *
      *****************************************************************
      *
      ...
      *
       ...
       FD INNPUT
               ...
               RECORD CONTAINS 128.
       01  INNPUT-IO-AREA.
           05  INNPUT-IO-AREA-X            PICTURE X(128).
       FD OUTPUT-X
               BLOCK CONTAINS 128
               RECORD CONTAINS 128.
       01  OUTPUT-X-IO-AREA.
           05  OUTPUT-X-IO-AREA-X          PICTURE X(128).
       ...
       INNPUT-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE INNPUT-IO-AREA (1:128) TO REC (1:128)
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               ...
               MOVE REC                    TO OUTPUT-X-IO-AREA (1:128)
