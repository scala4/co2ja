      ...
      *
       ...
       FD KOPI
               ...
               RECORD CONTAINS 200.
       01  KOPI-IO-AREA.
           05  KOPI-IO-AREA-X              PICTURE X(200).
       FD EDBTAB
               BLOCK CONTAINS 9000
               RECORD CONTAINS 20.
       01  EDBTAB-IO-AREA.
       ...
       KOPI-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE KOPI-IO-AREA (148:14)  TO EAN (1:14)
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-MR AND I-05)
               ...
               MOVE 'A'                    TO KOPIUT-IO-AREA (1:1)
               MOVE TFNR                   TO KOPIUT-IO-AREA (2:3)
               MOVE 'BAR'                  TO KOPIUT-IO-AREA (5:3)
               MOVE ' '                    TO KOPIUT-IO-AREA (8:1)
               MOVE EAN                    TO KOPIUT-IO-AREA (9:14)
