      ...
      **********************************************  Z-WIN-RPG2   ****
      *                                          XX2000XXIRXXMT      *
      *  MERGE KONTANT.FAKTURA.FILE MED KONTANT.BETALING.KODER       *
      *  HENT FAKTURA KUNDENR.                                       *
      ...
      *
       ...
       FD KORTFIL
               RECORD CONTAINS 20.
       01  KORTFIL-IO-AREA.
           05  KORTFIL-IO-AREA-X           PICTURE X(20).
       FD KONTFAK
               BLOCK CONTAINS 400
               RECORD CONTAINS 40.
       01  KONTFAK-IO-AREA.
       ...
       01  WORK-AREA-BATCH.
           ...
           05  KORTFIL-LEVEL-01.
               10  KORTFIL-01-L1.
                   15  KORTFIL-01-L1-FIRMA PICTURE X(3).
           05  KORTFIL-DATA-FIELDS.
               10  FIRMA                   PICTURE X(3).
               10  BETKOD                  PICTURE X(1).
               10  FAKKNR                  PICTURE X(6).
           05  KORTFIL-MP                  PICTURE X(4).
           05  KORTFIL-MC                  PICTURE X(4).
           05  KORTFIL-M-01            REDEFINES KORTFIL-MC.
               10  KORTFIL-M-01-M2.
                   15  KORTFIL-M-01-M2-FIRMA-G.
                       20  KORTFIL-M-01-M2-FIRMA PICTURE X(3).
               10  KORTFIL-M-01-M1.
                   15  KORTFIL-M-01-M1-BETKOD-G.
                       20  KORTFIL-M-01-M1-BETKOD PICTURE X(1).
           05  KONTFAK-LEVEL-02.
               10  KONTFAK-02-L1.
      ...
      ************************************************************
               10  FILLER                  PICTURE X.
           05  KONTFAK-MP                  PICTURE X(4).
           05  KONTFAK-MC                  PICTURE X(4).
           05  KONTFAK-M-02            REDEFINES KONTFAK-MC.
               10  KONTFAK-M-02-M2.
                   15  KONTFAK-M-02-M2-FIRMA-G.
                       20  KONTFAK-M-02-M2-FIRMA PICTURE X(3).
               10  KONTFAK-M-02-M1.
                   15  KONTFAK-M-02-M1-BETKOD-G.
                       20  KONTFAK-M-02-M1-BETKOD PICTURE X(1).
           05  THE-PRIOR-LEVEL.
      ...
      *****************************************************************
       ...
       KORTFIL-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE KORTFIL-IO-AREA (1:3)  TO FIRMA (1:3)
               MOVE KORTFIL-IO-AREA (4:1)  TO BETKOD (1:1)
               MOVE KORTFIL-IO-AREA (5:6)  TO FAKKNR (1:6)
           END-EVALUATE.
       ...
       KORTFIL-CHK-LEVEL-P.
           ...
           WHEN ANY
               ...
               MOVE KORTFIL-IO-AREA (1:3)  TO KORTFIL-01-L1-FIRMA
       ...
       KORTFIL-MATCH-SET SECTION.
       KORTFIL-MATCH-SET-P.
           SET CALL-MATCH-RECS             TO TRUE
           EVALUATE TRUE
           WHEN ANY
               MOVE KORTFIL-IO-AREA (1:3)  TO KORTFIL-M-01-M2-FIRMA
               MOVE KORTFIL-IO-AREA (4:1)  TO KORTFIL-M-01-M1-BETKOD
           END-EVALUATE.
       ...
       KONTFAK-MATCH-SET-P.
           ...
           WHEN ANY
               ...
               MOVE KONTFAK-IO-AREA (33:1) TO KONTFAK-M-02-M1-BETKOD
           END-EVALUATE.
       ...
       MATCHING-RECORDS-P.
           IF  KORTFIL-EOF
               MOVE HIGH-VALUES            TO KORTFIL-MC
                                              KORTFIL-MP
           END-IF
           IF  KONTFAK-EOF
           ...
           END-IF
           EVALUATE TRUE
           WHEN  KORTFIL-MC < KONTFAK-MC
               IF  RECORD-SELECTED-OFF
                   SET RECORD-SELECTED     TO TRUE
                   SET KORTFIL-PROCESS     TO TRUE
                   MOVE KORTFIL-MC         TO KORTFIL-MP
                   IF  KORTFIL-MC = KONTFAK-MP
                       SET SET-I-MR        TO TRUE
                   ELSE
                       SET NOT-SET-I-MR    TO TRUE
                   END-IF
               END-IF
           WHEN  KONTFAK-MC < KORTFIL-MC
               IF  RECORD-SELECTED-OFF
                   SET RECORD-SELECTED     TO TRUE
                   SET KONTFAK-PROCESS     TO TRUE
                   MOVE KONTFAK-MC         TO KONTFAK-MP
                   IF  KONTFAK-MC = KORTFIL-MP
                       SET SET-I-MR        TO TRUE
                   ELSE
                       SET NOT-SET-I-MR    TO TRUE
                   END-IF
      ...
      *****************************************************************
       ...
       HEADING-OUTPUT-P.
           IF  (I-1P)
               ...
               MOVE ' KONT.FAKT.REC MOT BETA' TO LISTE-IO-AREA (28:23)
               MOVE 'LINGS.KODER     ***'  TO LISTE-IO-AREA (51:19)
               ...
               MOVE 'ANT.BET.KODER'        TO LISTE-IO-AREA (8:13)
               MOVE 'ANT.FAKT.REC'         TO LISTE-IO-AREA (29:12)
               MOVE 'ANT.OPPDATERT'        TO LISTE-IO-AREA (48:13)
               MOVE 2                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF.
