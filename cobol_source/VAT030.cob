       ...
       PROGRAM-ID. VAT030R.
      **********************************************  Z-WIN-RPG2   ****
      **KVITTERINGSLISTE TELLEKORRIGERINGER.                             **
      ** GJELDER  T E N Y  UT I FRA AUTO.TRANSER1
      **          02.11.06  LAGT INN DAGENS BEHOLDNING.
      **          14.09.12  LAGT INN DESIMALER I DAGENS BEHOLDNING
      *********************************************************************
      *                                          XX2000XXIRXXSS
      *
      ...
      *                        AVD   1B  82
               ...
               MOVE 'VGR.   LOC. UTSALGSPRIS' TO LISTE-IO-AREA (57:23)
               MOVE 'SELVKOST SUM PT'      TO LISTE-IO-AREA (82:15)
               MOVE 'LK'                   TO LISTE-IO-AREA (98:2)
               MOVE 'ANTALL P/M    BEHOLD.' TO LISTE-IO-AREA (104:21)
               MOVE 'SIGN ID.'             TO LISTE-IO-AREA (125:8)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
           ...
           IF  (I-01 AND I-10 AND NOT-I-86)
               ...
               MOVE UTSALG                 TO XO-72YNZ
               MOVE XO-72YNZ               TO LISTE-IO-AREA (70:10)
               MOVE SELVK                  TO XO-72YNZ
               MOVE XO-72YNZ               TO LISTE-IO-AREA (84:10)
               MOVE PT                     TO LISTE-IO-AREA (95:1)
               MOVE LAGER                  TO LISTE-IO-AREA (97:2)
               MOVE ANT                    TO XO-62YNZ
               MOVE XO-62YNZ               TO LISTE-IO-AREA (101:9)
               MOVE SIGN-X                 TO LISTE-IO-AREA (111:1)
               IF  (NOT-I-12 AND I-30)
                   MOVE BEH                TO XO-72YY9R
                   MOVE XO-72YY9R          TO LISTE-IO-AREA (112:13)
               END-IF
               IF  (NOT-I-12 AND I-31)
                   MOVE UTL13              TO XO-50YN9R
                   MOVE XO-50YN9R          TO LISTE-IO-AREA (119:6)
               END-IF
               ...
               IF  (NOT-I-12 AND I-36)
                   ...
                   MOVE XO-50YN9R          TO LISTE-IO-AREA (119:6)
               END-IF
               MOVE INITI                  TO LISTE-IO-AREA (126:2)
