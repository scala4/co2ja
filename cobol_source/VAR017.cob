      ...
      *
       ...
       FD VARE
               ...
               RECORD CONTAINS 400.
       01  VARE-IO-AREA.
           05  VARE-IO-AREA-X              PICTURE X(400).
       FD VAREUT
               BLOCK CONTAINS 8000
               RECORD CONTAINS 400.
       01  VAREUT-IO-AREA.
           05  VAREUT-IO-AREA-X            PICTURE X(400).
      ...
      * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
       ...
       VARE-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE VARE-IO-AREA (201:200) TO REC2 (1:200)
               MOVE VARE-IO-AREA (213:20)  TO ARTNR (1:20)
               MOVE VARE-IO-AREA (218:15)  TO ART5 (1:15)
               IF  ART5 = SPACES
                   SET I-05                TO TRUE
               END-IF
               MOVE VARE-IO-AREA (223:10)  TO ART10 (1:10)
               IF  ART10 = SPACES
                   SET I-06                TO TRUE
               END-IF
               MOVE VARE-IO-AREA (228:5)   TO ART15 (1:5)
               IF  ART15 = SPACES
                   SET I-07                TO TRUE
               END-IF
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               ...
               MOVE REC1                   TO VAREUT-IO-AREA (1:200)
               MOVE REC2                   TO VAREUT-IO-AREA (201:200)
               MOVE 233                    TO BW-A
