      ...
      *****************************************************************
      **********************************************  Z-WIN-RPG2   ****
      *  PROGRAM.......: VOS014, SANERING AV VERKSTED FIRMA.          *
      *  PROGRAMMERER..: MORTEN TUVRØNNINGEN                          *
      *  KJØRES I JOBB.: VERK020, REORG. AV VERKSTED.FIRMA.FILE       *
      *  LAGET DATO....: 27.06.95                                     *
      *  ENDRET........: 27.12.99 SKRIVER KVITTERING NÅR U1 ER PÅ.    *
      *                  11.02.02 ENDRET TEKST.                       *
      *  RETTET........:                                              *
      *  INPUT.........: FIRMAPAR M/FIRMANR SOM SKAL SANERES.         *
      *                  SEKVENSIELL VERKSTED FIRMA FILE (VERK020).   *
      *  BEHANDLING....: SANERER RECORDS TIL SLETTEDE FIRMA.          *
      *  OUTPUT........: SANERT SEKV. VERKSTED FIRMA FILE (VERK020).  *
      *****************************************************************
      *
      ...
      *
       ...
       FILE-CONTROL.
           SELECT VERK10I
               ASSIGN TO UT-S-VERK10I
               ACCESS MODE IS SEQUENTIAL
               ORGANIZATION IS SEQUENTIAL
               STATUS IS VERK10I-STATUS.
           SELECT VERKSAN
           ...
           SELECT VERK10O
               ASSIGN TO UT-S-VERK10O
               ACCESS MODE IS SEQUENTIAL
               ORGANIZATION IS SEQUENTIAL
               STATUS IS VERK10O-STATUS.
           SELECT KLISTEO
       ...
       FD VERK10I
               ...
               RECORD CONTAINS 120.
       01  VERK10I-IO-AREA.
           05  VERK10I-IO-AREA-X           PICTURE X(120).
       FD VERKSAN
               BLOCK CONTAINS 40
               RECORD CONTAINS 4.
       01  VERKSAN-IO-AREA.
       ...
       FD VERK10O
               ...
               RECORD CONTAINS 120.
       01  VERK10O-IO-AREA.
           05  VERK10O-IO-AREA-X           PICTURE X(120).
      *BUGFILO O   F  80  80            PRINTERSYSLST
       ...
       01  FILE-STATUS-TABLE.
           10  VERK10I-STATUS              PICTURE 99 VALUE 0.
           10  VERKSAN-STATUS              PICTURE 99 VALUE 0.
           10  VERK10O-STATUS              PICTURE 99 VALUE 0.
           10  KLISTEO-STATUS              PICTURE 99 VALUE 0.
 
       01  WORK-AREA-BATCH.
           05  FILLER                      PIC X VALUE '0'.
               88  VERK10I-EOF-OFF         VALUE '0'.
               88  VERK10I-EOF             VALUE '1'.
           05  FILLER                      PIC X VALUE '0'.
               88  VERK10I-READ-OFF        VALUE '0'.
               88  VERK10I-READ            VALUE '1'.
           05  FILLER                      PIC X VALUE '0'.
               88  VERK10I-PROCESS-OFF     VALUE '0'.
               88  VERK10I-PROCESS         VALUE '1'.
           05  FILLER                      PIC X VALUE '0'.
           ...
           05  VERK10I-DATA-FIELDS.
               10  FIRKEY                  PICTURE X(3).
               10  REC120                  PICTURE X(120).
           05  VERK10I-MP                  PICTURE X(3).
           05  VERK10I-MC                  PICTURE X(3).
           05  VERK10I-M-01            REDEFINES VERK10I-MC.
               10  VERK10I-M-01-M1.
                   15  VERK10I-M-01-M1-FIRKEY-G.
                       20  VERK10I-M-01-M1-FIRKEY PICTURE X(3).
       ...
       MAINLINE-LOOP.
           ...
           IF  VERK10I-PROCESS
               SET VERK10I-PROCESS-OFF     TO TRUE
               SET VERK10I-READ            TO TRUE
           END-IF
 
           IF  VERK10I-READ
               PERFORM VERK10I-GET
               SET VERK10I-READ-OFF        TO TRUE
               IF  NOT VERK10I-EOF
                   PERFORM VERK10I-MATCH-SET
               END-IF
           END-IF
       ...
       DETAIL-CALCS-P.
           ...
           IF  (I-01 AND I-MR)
               ADD 1                       TO ANTSAN
      *  01 MR             MOVE "ANTSAN  "BUGFL1  8        LEDETXT DEBUG
      *  01 MR   BUGFL1    DEBUGBUGFILO   ANTSAN           VIS FELT/IND
      *  01 MR             MOVE "REC120  "BUGFL1  8        LEDETXT DEBUG
      *  01 MR   BUGFL1    DEBUGBUGFILO   REC120           VIS FELT/IND
           END-IF
       ...
       VERK10I-GET-P.
           IF  VERK10I-EOF-OFF
               READ VERK10I
               AT END
                   SET VERK10I-EOF         TO TRUE
                   SUBTRACT 1            FROM LR-CHECK
               END-READ
           END-IF.
 
       VERK10I-FLDSET SECTION.
       VERK10I-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE VERK10I-IO-AREA (1:3)  TO FIRKEY (1:3)
               MOVE VERK10I-IO-AREA (1:120) TO REC120 (1:120)
           END-EVALUATE.
 
       VERK10I-IDSET SECTION.
       VERK10I-IDSET-P.
           SET I-01                        TO TRUE.
 
       VERK10I-MATCH-SET SECTION.
       VERK10I-MATCH-SET-P.
           SET CALL-MATCH-RECS             TO TRUE
           EVALUATE TRUE
           WHEN ANY
               MOVE VERK10I-IO-AREA (1:3)  TO VERK10I-M-01-M1-FIRKEY
           END-EVALUATE.
       ...
       MATCHING-RECORDS-P.
           IF  VERK10I-EOF
               MOVE HIGH-VALUES            TO VERK10I-MC
                                              VERK10I-MP
           END-IF
           IF  VERKSAN-EOF
           ...
           END-IF
           EVALUATE TRUE
           WHEN  VERK10I-MC < VERKSAN-MC
               IF  RECORD-SELECTED-OFF
                   SET RECORD-SELECTED     TO TRUE
                   SET VERK10I-PROCESS     TO TRUE
                   MOVE VERK10I-MC         TO VERK10I-MP
                   IF  VERK10I-MC = VERKSAN-MP
                       SET SET-I-MR        TO TRUE
                   ELSE
                       SET NOT-SET-I-MR    TO TRUE
                   END-IF
               END-IF
           WHEN  VERKSAN-MC < VERK10I-MC
               IF  RECORD-SELECTED-OFF
                   SET RECORD-SELECTED     TO TRUE
                   SET VERKSAN-PROCESS     TO TRUE
                   MOVE VERKSAN-MC         TO VERKSAN-MP
                   IF  VERKSAN-MC = VERK10I-MP
                       SET SET-I-MR        TO TRUE
                   ELSE
                       SET NOT-SET-I-MR    TO TRUE
                   END-IF
       ...
       DETAIL-OUTPUT-P.
           IF  (NOT-I-MR AND I-01)
               MOVE SPACES TO VERK10O-IO-AREA
               INITIALIZE VERK10O-IO-AREA
               MOVE REC120                 TO VERK10O-IO-AREA (1:120)
               WRITE VERK10O-IO-AREA
           END-IF
       ...
       HEADING-OUTPUT-P.
           IF  (I-1P)
               ...
               MOVE 'KONTROLL-LISTE SANERING ' TO KLISTEO-IO-AREA
                                                                (1:24)
               MOVE 'AV VERKSTED-FIRMA       ' TO KLISTEO-IO-AREA
                                                               (25:24)
               MOVE 'DATO:'                TO KLISTEO-IO-AREA (53:5)
               MOVE UDATE                  TO EDIT-DATE
               MOVE EDIT-DATE (7:8)        TO KLISTEO-IO-AREA (58:8)
               MOVE 'JOB=VERK010'          TO KLISTEO-IO-AREA (95:11)
               MOVE 'PROGRAM=VOS014'       TO KLISTEO-IO-AREA (107:14)
               IF  I-U1
       ...
       INITIALIZATION-P.
           ...
           MOVE 2                          TO LR-CHECK
           INITIALIZE VERK10I-DATA-FIELDS
           SET VERK10I-EOF-OFF             TO TRUE
           SET VERK10I-PROCESS             TO TRUE
           MOVE LOW-VALUES                 TO VERK10I-MC
                                              VERK10I-MP
           OPEN INPUT VERK10I
