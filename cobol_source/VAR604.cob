      ...
      * ENDRER VGRNAVN, KONTO OG FORTJ.PROS                           *
      *****************************************************************
      *
      ...
      *
       ...
       01  WORK-AREA-BATCH.
           ...
           05  VGRKOPI-DATA-FIELDS.
               ...
               10  KONTO1                  PICTURE X(4).
               10  FORTJ1                  PICTURE X(4).
       ...
       VGRKOPI-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE VGRKOPI-IO-AREA (69:4) TO KONTO1 (1:4)
               MOVE VGRKOPI-IO-AREA (77:4) TO FORTJ1 (1:4)
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-04 AND I-11 AND NOT-I-20)
               ...
               MOVE KONTO1                 TO VAGRMAS-IO-AREA (69:4)
               MOVE FORTJ1                 TO VAGRMAS-IO-AREA (77:4)
