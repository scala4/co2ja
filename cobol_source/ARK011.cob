      ...
      *
       ...
       01  STYFILE-IO-AREA.
           05  STYFILE-IO-AREA-X.
               10  STYFILE-KEY1.
                   15  STYFILE-KEY1N       PICTURE S9(11).
      ...
      ******************************************************
       ...
       STYFILE-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE STYFILE-IO-AREA (2:8)  TO KEY-X (1:8)
               MOVE STYFILE-IO-AREA (80:1) TO SLETT (1:1)
           END-EVALUATE.
       ...
       TOTAL-OUTPUT-P.
           IF  (I-LR)
               MOVE SPACES TO TOTALER-IO-AREA
               INITIALIZE TOTALER-IO-AREA
               MOVE ANTT                   TO XO-50YY9
               MOVE XO-50YY9               TO TOTALER-IO-AREA (5:6)
               MOVE 'RECORDS INN FAKTOR.FILE' TO TOTALER-IO-AREA
                                                               (12:23)
               ...
               MOVE XO-50YY9               TO TOTALER-IO-AREA (5:6)
               MOVE 'RECORDS UT FAKTOR.FILE ' TO TOTALER-IO-AREA
                                                               (12:23)
               MOVE 3                      TO TOTALER-AFTER-SPACE
               PERFORM TOTALER-PRINT-LINE
               MOVE SPACES TO TOTALER-IO-AREA
