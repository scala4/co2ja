      ...
      * * END   RBS - PARAMETERKORT OVERSTYRING AV RBS-FILE  * *
           ...
           05  FRAKTED-LEVEL-01.
               10  FRAKTED-01-L4.
                   15  FRAKTED-01-L4-FNR   PICTURE X(3).
               10  FRAKTED-01-L3.
                   15  FRAKTED-01-L3-DATO  PICTURE S9(6).
               10  FRAKTED-01-L2.
                   15  FRAKTED-01-L2-RUTENR PICTURE X(2).
               10  FRAKTED-01-L1.
                   15  FRAKTED-01-L1-KUNDE PICTURE X(6).
           05  FRAKTED-DATA-FIELDS.
               10  KEY-X                   PICTURE X(17).
               10  BRUDD                   PICTURE X(6).
               10  RA                      PICTURE X(3).
               10  FNR                     PICTURE X(3).
               ...
               10  MPNR                    PICTURE X(4).
               10  MPSTED                  PICTURE X(15).
               10  MNAVN1                  PICTURE X(30).
               10  KUNDE                   PICTURE X(6).
               10  RUTENR                  PICTURE X(2).
               10  BETKOD                  PICTURE X(1).
               10  BRUTTO-IO.
                   15  BRUTTO              PICTURE S9(5).
               10  RABATT-IO.
                   15  RABATT              PICTURE S9(5).
               10  DATO-IO.
      ...
      **************************************************************
           ...
           05  TEMPORARY-FIELDS.
               10  L4ARUT-IO.
                   15  L4ARUT              PICTURE S9(6).
               10  KLOKKE-IO.
                   15  KLOKKE              PICTURE S9(6).
               10  L3ARUT-IO.
                   15  L3ARUT              PICTURE S9(6).
               10  L2ARUT-IO.
                   15  L2ARUT              PICTURE S9(6).
               10  L1ARUT-IO.
                   15  L1ARUT              PICTURE S9(6).
               10  L1SUM-IO.
                   15  L1SUM               PICTURE S9(6).
               10  L2SUM-IO.
                   15  L2SUM               PICTURE S9(6).
               10  L3SUM-IO.
                   15  L3SUM               PICTURE S9(6).
               10  L4SUM-IO.
                   15  L4SUM               PICTURE S9(6).
               10  L1KUM-IO.
                   15  L1KUM               PICTURE S9(6).
               10  L2KUM-IO.
                   15  L2KUM               PICTURE S9(6).
               10  L3KUM-IO.
                   15  L3KUM               PICTURE S9(6).
               10  L4KUM-IO.
                   15  L4KUM               PICTURE S9(6).
           05  EDITTING-FIELDS.
      ...
      ******************************************************
       ...
       FRAKTED-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE FRAKTED-IO-AREA (1:17) TO KEY-X (1:17)
               MOVE FRAKTED-IO-AREA (1:6)  TO BRUDD (1:6)
               MOVE FRAKTED-IO-AREA (1:3)  TO RA (1:3)
       ...
       FRAKTED-CHK-LEVEL-P.
           ...
           WHEN ANY
               ...
               MOVE FRAKTED-IO-AREA (4:3)  TO FRAKTED-01-L4-FNR
               MOVE FRAKTED-IO-AREA (1045:6) TO FRAKTED-01-L3-DATO
               MOVE FRAKTED-IO-AREA (401:2) TO FRAKTED-01-L2-RUTENR
               MOVE FRAKTED-IO-AREA (342:6) TO FRAKTED-01-L1-KUNDE
               IF  FRAKTED-LEVEL-INIT
                   EVALUATE TRUE
                   WHEN  FRAKTED-01-L4 NOT = THE-PRIOR-L4
                       PERFORM SETON-I-L4
                   WHEN  FRAKTED-01-L3 NOT = THE-PRIOR-L3
                       PERFORM SETON-I-L3
                   ...
                   END-EVALUATE
               END-IF
               MOVE  FRAKTED-01-L4         TO THE-PRIOR-L4
               MOVE  FRAKTED-01-L3         TO THE-PRIOR-L3
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01 AND I-32)
               ...
               MOVE EDIT-DATE (7:8)        TO LISTE-IO-AREA (1:8)
               MOVE ORDRE                  TO LISTE-IO-AREA (10:6)
               MOVE KUNDE                  TO LISTE-IO-AREA (18:6)
               MOVE MNAVN                  TO LISTE-IO-AREA (25:30)
               MOVE MADR                   TO LISTE-IO-AREA (56:30)
               MOVE BETKOD                 TO LISTE-IO-AREA (97:1)
               IF  (NOT-I-71)
                   MOVE FSUM               TO XO-60YYZ
                   MOVE XO-60YYZ           TO LISTE-IO-AREA (114:7)
                   INITIALIZE FSUM
               END-IF
               MOVE KSUM                   TO XO-60YYZ
               MOVE XO-60YYZ               TO LISTE-IO-AREA (123:7)
               INITIALIZE KSUM
               MOVE RUTENR                 TO LISTE-IO-AREA (131:2)
       ...
       HEADING-OUTPUT-P.
           IF  (I-L2 AND I-98)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE FNAVN                  TO LISTE-IO-AREA (1:30)
               MOVE 'LISTE FRAKTBREVKUNDER ' TO LISTE-IO-AREA (45:22)
               MOVE 'DATO'                 TO LISTE-IO-AREA (90:4)
               MOVE UDATE                  TO EDIT-DATE
               MOVE EDIT-DATE (7:8)        TO LISTE-IO-AREA (95:8)
               MOVE 'RUTE: '               TO LISTE-IO-AREA (114:6)
               MOVE RUTENR                 TO LISTE-IO-AREA (122:2)
               ...
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'DATO    ORDRE'        TO LISTE-IO-AREA (1:13)
               MOVE 'KUNDE'                TO LISTE-IO-AREA (18:5)
               MOVE 'ADRESSE'              TO LISTE-IO-AREA (42:7)
               MOVE 'ADRESSE      '        TO LISTE-IO-AREA (66:13)
               MOVE 'BELAST   '            TO LISTE-IO-AREA (92:9)
               MOVE 'PRIS '                TO LISTE-IO-AREA (114:5)
               MOVE '    KOST '            TO LISTE-IO-AREA (121:9)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
       ...
       TOTAL-OUTPUT-P.
           IF  (I-L2 AND I-62)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'TOTALT RUTE '         TO LISTE-IO-AREA (69:12)
               MOVE L2ARUT                 TO XO-60YYZ
               MOVE XO-60YYZ               TO LISTE-IO-AREA (94:7)
               INITIALIZE L2ARUT
               MOVE L2SUM                  TO XO-60YYZ
               MOVE XO-60YYZ               TO LISTE-IO-AREA (114:7)
               INITIALIZE L2SUM
               MOVE L2KUM                  TO XO-60YYZ
               MOVE XO-60YYZ               TO LISTE-IO-AREA (123:7)
               INITIALIZE L2KUM
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           ...
           IF  (I-L4 AND I-64)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'TOTALT FIRMA'         TO LISTE-IO-AREA (69:12)
               MOVE L4ARUT                 TO XO-60YYZ
               MOVE XO-60YYZ               TO LISTE-IO-AREA (94:7)
               MOVE L4SUM                  TO XO-60YYZ
               MOVE XO-60YYZ               TO LISTE-IO-AREA (114:7)
               MOVE L4KUM                  TO XO-60YYZ
               MOVE XO-60YYZ               TO LISTE-IO-AREA (123:7)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF.
