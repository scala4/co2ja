      ...
      **          27.11.96  PR ALFA OG ARTIKKELNUMMER.
      ...
      *                        AVD   1B  82
               ...
               MOVE 'VGR.   LOC. SELVKOSTPR.' TO LISTE-IO-AREA (57:23)
               MOVE 'SELVKOST SUM PT'      TO LISTE-IO-AREA (82:15)
               MOVE 'LAGER'                TO LISTE-IO-AREA (98:5)
               MOVE 'ANTALL P/M BEHOLD.  ' TO LISTE-IO-AREA (107:20)
      ...
      *                        UTSALG4   79
               ...
               MOVE LAGER                  TO LISTE-IO-AREA (100:2)
               MOVE ANT                    TO XO-62YNZ
               MOVE XO-62YNZ               TO LISTE-IO-AREA (104:9)
               MOVE SIGN-X                 TO LISTE-IO-AREA (114:1)
               IF  (NOT-I-12 AND I-30)
                   MOVE BEH                TO XO-90YN9R
                   MOVE XO-90YN9R          TO LISTE-IO-AREA (115:10)
               END-IF
