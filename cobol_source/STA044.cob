      ...
      ******************************************************
       ...
       DETAIL-OUTPUT-P.
           IF  (I-04 AND NOT-I-86)
               ...
               MOVE XO-52YY9R              TO LISTE-IO-AREA (53:10)
       ...
       HEADING-OUTPUT-P.
           IF  (I-L3 AND NOT-I-86)
               ...
               MOVE MNDNAV                 TO LISTE-IO-AREA (74:9)
               ...
               MOVE 'ANTALL LEV.'          TO LISTE-IO-AREA (52:11)
       ...
       TOTAL-OUTPUT-P.
           IF  (I-L2 AND NOT-I-86)
               ...
               INITIALIZE KSUMVL
               MOVE 'KUNDENS NETTOBELØP='  TO LISTE-IO-AREA (36:19)
