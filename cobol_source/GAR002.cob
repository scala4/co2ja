      ...
      *
       ...
       GBANKS-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE GBANKS-IO-AREA (28:30) TO NAVN (1:30)
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               ...
               MOVE '2'                    TO ALFFIL-IO-AREA (7:1)
               MOVE NAVN                   TO ALFFIL-IO-AREA (8:30)
               MOVE SEQ1-IO                TO ALFFIL-IO-AREA (38:4)
