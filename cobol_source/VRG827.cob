       ...
       PROGRAM-ID. VRG827R.
      ******************************************* :   Z-WIN-RPG2P    **
      *  KOPI AV VRG816, MEN BARE ARTIKLER SOM FINNES FRA FØR           ***
      ...
      *
       ...
       FILE-CONTROL.
           ...
           SELECT VAREOUT
               ASSIGN TO UT-S-VAREOUT
               ACCESS MODE IS SEQUENTIAL
               ORGANIZATION IS SEQUENTIAL
               STATUS IS VAREOUT-STATUS.
           SELECT SLETTF
       ...
       FD VAREOUT
               ...
               RECORD CONTAINS 200.
       01  VAREOUT-IO-AREA.
           05  VAREOUT-IO-AREA-X           PICTURE X(200).
       FD SLETTF
               BLOCK CONTAINS 2600
               RECORD CONTAINS 200.
       01  SLETTF-IO-AREA.
      ...
      * **START RBS - DATASTRUKTUR FOR SUB-PROGRAM RBS000 ********
       ...
       01  FILE-STATUS-TABLE.
           ...
           10  VAREOUT-STATUS              PICTURE 99 VALUE 0.
      ...
      ******************************************************
       ...
       DETAIL-OUTPUT-P.
           ...
           AND (NOT-I-59)
               MOVE SPACES TO VAREOUT-IO-AREA
               INITIALIZE VAREOUT-IO-AREA
               MOVE REC1                   TO VAREOUT-IO-AREA (1:200)
      *                        REC13     15
               MOVE REC21                  TO VAREOUT-IO-AREA (3:33)
               IF  (NOT-I-57 AND NOT-I-44)
                   MOVE KOPBET             TO VAREOUT-IO-AREA (36:30)
               END-IF
               IF  (NOT-I-60 AND NOT-I-45)
                   MOVE KOPSKP             TO VAREOUT-IO-AREA (66:9)
               END-IF
               IF  (NOT-I-61 AND NOT-I-58 AND NOT-I-46)
                   MOVE KOPUTP             TO VAREOUT-IO-AREA (75:9)
               END-IF
               MOVE ENDRET                 TO XO-70P
               MOVE XO-70P-EF              TO VAREOUT-IO-AREA (84:4)
               IF  (NOT-I-58)
                   MOVE PT                 TO VAREOUT-IO-AREA (95:1)
               END-IF
               IF  (NOT-I-60 AND NOT-I-61 AND NOT-I-49)
                   MOVE 'A'                TO VAREOUT-IO-AREA (96:1)
               END-IF
               IF  (I-62 AND NOT-I-49)
                   MOVE 'L'                TO VAREOUT-IO-AREA (96:1)
               END-IF
               IF  (NOT-I-60 AND NOT-I-61 AND I-49)
                   MOVE ' '                TO VAREOUT-IO-AREA (96:1)
               END-IF
               IF  (I-48)
                   MOVE PRISTT             TO VAREOUT-IO-AREA (107:1)
               END-IF
               MOVE VGR                    TO VAREOUT-IO-AREA (118:5)
               IF  (I-50 AND NOT-I-75 AND I-91)
                   MOVE ' '                TO VAREOUT-IO-AREA (127:1)
               END-IF
               IF  (I-50 AND I-92)
                   MOVE MERKN              TO VAREOUT-IO-AREA (127:1)
               END-IF
               IF  (I-50 AND I-93 AND NOT-I-75)
                   MOVE MERKN              TO VAREOUT-IO-AREA (127:1)
               END-IF
               MOVE ' '                    TO VAREOUT-IO-AREA (128:1)
               IF  (NOT-I-62 AND I-52)
                   MOVE LEVRAB             TO XO-21P
                   MOVE XO-21P-EF          TO VAREOUT-IO-AREA (153:2)
               END-IF
               IF  (I-48)
                   MOVE PRISTI             TO XO-52P
                   MOVE XO-52P-EF          TO VAREOUT-IO-AREA (161:4)
               END-IF
               IF  (NOT-I-62 AND I-51)
                   MOVE LEVPRI             TO XO-72P
                   MOVE XO-72P-EF          TO VAREOUT-IO-AREA (165:5)
               END-IF
               WRITE VAREOUT-IO-AREA
           END-IF
           IF  (I-02 AND NOT-I-MR AND NOT-I-90)
               MOVE SPACES TO VAREOUT-IO-AREA
               INITIALIZE VAREOUT-IO-AREA
               MOVE '70'                   TO VAREOUT-IO-AREA (1:2)
               MOVE REC22                  TO VAREOUT-IO-AREA (3:81)
               MOVE ENDRET                 TO XO-70P
               MOVE XO-70P-EF              TO VAREOUT-IO-AREA (84:4)
               MOVE PT                     TO VAREOUT-IO-AREA (95:1)
               IF  (NOT-I-49)
               ...
               MOVE XO-72P-EF              TO VAREOUT-IO-AREA (97:5)
               MOVE FELT92                 TO XO-72P
               MOVE XO-72P-EF              TO VAREOUT-IO-AREA (102:5)
               IF  (I-48)
                   MOVE PRISTT             TO VAREOUT-IO-AREA (107:1)
               END-IF
               MOVE FELT50                 TO XO-50P
               MOVE XO-50P-EF              TO VAREOUT-IO-AREA (108:3)
               MOVE FELT50                 TO XO-50P
               MOVE XO-50P-EF              TO VAREOUT-IO-AREA (111:3)
               MOVE FELT50                 TO XO-50P
               MOVE XO-50P-EF              TO VAREOUT-IO-AREA (114:3)
               MOVE VGR                    TO VAREOUT-IO-AREA (118:5)
               IF  (NOT-I-50)
                   MOVE ' '                TO VAREOUT-IO-AREA (127:1)
               END-IF
               ...
               IF  (I-50 AND I-93)
                   MOVE MERKN              TO VAREOUT-IO-AREA (127:1)
               END-IF
               MOVE '0000000'              TO VAREOUT-IO-AREA (129:7)
               IF  (I-52)
                   MOVE LEVRAB             TO XO-21P
                   MOVE XO-21P-EF          TO VAREOUT-IO-AREA (153:2)
               END-IF
               ...
               MOVE XO-60P-EF              TO VAREOUT-IO-AREA (156:4)
               MOVE A-ELGR                 TO VAREOUT-IO-AREA (171:2)
               MOVE MND                    TO VAREOUT-IO-AREA (173:2)
               IF  (I-48)
                   MOVE PRISTI             TO XO-52P
                   MOVE XO-52P-EF          TO VAREOUT-IO-AREA (161:4)
               END-IF
               ...
               MOVE XO-70P-EF              TO VAREOUT-IO-AREA (175:4)
               MOVE FELT50                 TO XO-50P
               MOVE XO-50P-EF              TO VAREOUT-IO-AREA (179:3)
               MOVE FELT50                 TO XO-50P
               MOVE XO-50P-EF              TO VAREOUT-IO-AREA (182:3)
               MOVE FELT50                 TO XO-50P
               MOVE XO-50P-EF              TO VAREOUT-IO-AREA (185:3)
               MOVE FELT50                 TO XO-50P
               MOVE XO-50P-EF              TO VAREOUT-IO-AREA (188:3)
               MOVE FELT50                 TO XO-50P
               MOVE XO-50P-EF              TO VAREOUT-IO-AREA (191:3)
               MOVE FELT50                 TO XO-50P
               MOVE XO-50P-EF              TO VAREOUT-IO-AREA (194:3)
               MOVE FELT50                 TO XO-50P
               MOVE XO-50P-EF              TO VAREOUT-IO-AREA (197:3)
               WRITE VAREOUT-IO-AREA
           END-IF
       ...
       HEADING-OUTPUT-P.
           IF  (I-02 AND I-70 AND NOT-I-86)
               ...
               MOVE '  PRIS    SELVKOST PT  T' TO LISTE-IO-AREA (73:24)
               MOVE 'ILLEGG  MERKNAD         ' TO LISTE-IO-AREA (97:24)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
