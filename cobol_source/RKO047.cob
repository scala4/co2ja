       ...
       PROGRAM-ID. RKO047R.
      **********************************************  Z-WIN-RPG2   ****
      * NY VERSJON AV RSK.RSK047                 ***TXT***OK MT
      *  PROGRAM....: RKO047 - FØR SEPT.05-RSK047                     *
      *  PROGRAM....: RKO047, OPPDAT MÅNEDENS KONTOKURANT.            *
      *  PROGRAM.......: RSK047                                       *
      *  PROGRAMMET DANNER NY RESKONTROMASTER, SAMT SUMFILE           *
      *  PR KUNDE TIL TOTALSALDO I KUNDEMA.                           *
      *  17/12-93 SAVE NULLPOSTER SOM SKAL TIL ALDERSFORDELT          *
      *           SALDOLISTE.                                         *
      *  11/10-99 TATT UT SISTE BRUKTE LINJENR.                       *
      *  01/06-01 TATT UT BLANKING AV KODE (POS 89).                  *
      *  11/06-01 BLANKER ALLE UNNTATT ANSATTE MED LØNNSTREKK, KODE=L.*
      *  12/06-01 LAGT INN BLANKING AV KODE (POS 89).                 *
      * 15.04.11  TAR MED UTVIDET BELØPSFELT                          *
      *           HAR IKKE ENDRET SUMFILE. MÅ ENDRES VED OMLEGGING TIL*
      *           BRUK AV UTVIDET BELØPSFELT.                         *
      * 08.10.12  SKRIVER AVSTEMMINGSFIL                              *
      * 10.10.12  RETTET PROGRAMNAVN                                  *
      *****************************************************************
      *
      ...
      *  89      BUGFL1    DEBUGBUGFILO   DDATO8           VIS INDIKATOR
       ...
       DETAIL-OUTPUT-P.
           IF  (I-02 AND I-90)
               MOVE SPACES TO RESKOMA-IO-AREA
               INITIALIZE RESKOMA-IO-AREA
               MOVE REC                    TO RESKOMA-IO-AREA (1:200)
      *                        LINJE     21
               MOVE ' '                    TO RESKOMA-IO-AREA (89:1)
               WRITE RESKOMA-IO-AREA
           END-IF
