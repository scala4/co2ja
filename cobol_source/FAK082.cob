      ...
      *
       ...
       01  WORK-AREA-BATCH.
           ...
           05  FAKSALG-DATA-FIELDS.
               ...
               10  FAKAAR-IO.
                   15  FAKAAR              PICTURE S9(2).
               10  FAKMM-IO.
                   15  FAKMM               PICTURE S9(2).
      ...
      *****************************************************************
           ...
           MOVE AAR                        TO AAMM (1:2)
           MOVE MND                        TO AAMM (3:2)
           MOVE '20'                       TO FRAMND (1:2)
           MOVE AAMM                       TO FRAMND (3:4)
           ADD 1                           TO ANT
           SUBTRACT 1 FROM AAR         GIVING FJOR
      *          FAKMND    COMP "201301"                 11 LAVERE
      * N11                GOTO SLUTT                                          8
      *          FAKMND    COMP "201201"               11   LAVERE
      *  11                GOTO SLUTT                                          8
      ...
      *****************************************************************
       ...
       FAKSALG-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE FAKSALG-IO-AREA (6:2)  TO FAKAAR-IO
               INSPECT FAKAAR-IO REPLACING ALL ' ' BY '0'
               MOVE FAKSALG-IO-AREA (8:2)  TO FAKMM-IO
               INSPECT FAKMM-IO REPLACING ALL ' ' BY '0'
       ...
       DETAIL-OUTPUT-P.
           IF  (I-1P)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'AVSTEMMING PROG. FAK076 ' TO LISTE-IO-AREA (1:24)
               ...
               MOVE 'FAKT SALGDATA '       TO LISTE-IO-AREA (36:14)
