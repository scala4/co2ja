      ...
      *****************************************************************
      *****************************************************************
      * CHAIN MOT VAGRMAS FOR Å HENTE VAREGRUPPENAVN                  *
      *****************************************************************
           END-IF
           IF  (I-L1)
       ...
       VAGRMAS-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE VAGRMAS-IO-AREA (11:35) TO VGRNVN (1:35)
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               ...
               IF  (NOT-I-10)
                   MOVE NAVN               TO OUTFIL-IO-AREA (101:30)
               END-IF
               IF  (I-10)
                   MOVE '*** KUNDENR UKJENT ***' TO OUTFIL-IO-AREA
                                                              (101:22)
               END-IF
               IF  (NOT-I-10)
                   MOVE HND-IO             TO OUTFIL-IO-AREA (131:3)
               END-IF
               IF  (I-10)
                   MOVE '000'              TO OUTFIL-IO-AREA (131:3)
               END-IF
               IF  (NOT-I-10)
                   MOVE KAT                TO XO-30U
                   MOVE XO-30U (1:3)       TO OUTFIL-IO-AREA (140:3)
               END-IF
               MOVE KONSF                  TO OUTFIL-IO-AREA (143:3)
               IF  (NOT-I-15)
                   MOVE VGRNVN             TO OUTFIL-IO-AREA (146:35)
               END-IF
               IF  (I-15)
                   MOVE '*** VAREGR  UKJENT ***' TO OUTFIL-IO-AREA
                                                              (146:22)
               END-IF
