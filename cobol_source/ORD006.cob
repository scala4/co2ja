       ...
       PROGRAM-ID. ORD006R.
      **********************************************  Z-WIN-RPG2   ****
      * LISTE OVER ALLE ORDRE PÅ PAK1  XORD35A(DOP01UD)      *
      ****************************************************************
      *
      ...
      *
       ...
       FD INNPUT
               ...
               RECORD CONTAINS 300.
       01  INNPUT-IO-AREA.
           05  INNPUT-IO-AREA-X            PICTURE X(300).
      ...
      * **START RBS - DATASTRUKTUR FOR SUB-PROGRAM RBS000 ********
           05  INNPUT-LEVEL-01.
               ...
               10  INNPUT-01-L1.
                   15  INNPUT-01-L1-KUNDNR PICTURE X(6).
           05  INNPUT-DATA-FIELDS.
               ...
               10  PVEKT-IO.
                   15  PVEKT               PICTURE S9(3)V9(1).
               10  PPORTO-IO.
                   15  PPORTO              PICTURE S9(4)V9(2).
               10  STATUS-X                PICTURE X(1).
               10  VADR1                   PICTURE X(30).
               10  VADR2                   PICTURE X(30).
               10  VADR3                   PICTURE X(27).
      ...
      **************************************************************
           ...
           05  TEMPORARY-FIELDS.
               10  FNRSUM-IO.
                   15  FNRSUM              PICTURE S9(7)V9(2).
           05  EDITTING-FIELDS.
               10  XO-40YNZ                PICTURE ZZZZ.
               10  XO-31YYZ                PICTURE ZZZ,Z.
               10  XO-42YY9                PICTURE Z.ZZZ,99.
      ...
      **************************************************************
           ...
           END-IF
           IF  (I-10)
               SUBTRACT PPORTO             FROM FNRSUM
           END-IF
           IF  (NOT-I-10)
               ADD PPORTO                  TO FNRSUM
      ******************************************************
      ...
      ******************************************************
       ...
       INNPUT-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE INNPUT-IO-AREA (4:6)   TO ORDNR (1:6)
               MOVE INNPUT-IO-AREA (4:1)   TO ORDNR1 (1:1)
               MOVE INNPUT-IO-AREA (10:6)  TO KUNDNR (1:6)
               MOVE INNPUT-IO-AREA (16:30) TO NAVN1 (1:30)
               MOVE INNPUT-IO-AREA (46:30) TO NAVN2 (1:30)
               MOVE INNPUT-IO-AREA (76:30) TO ADR (1:30)
               MOVE INNPUT-IO-AREA (106:4) TO PNR (1:4)
               MOVE INNPUT-IO-AREA (110:15) TO PSTED (1:15)
               MOVE INNPUT-IO-AREA (125:1) TO PTYPE (1:1)
               MOVE INNPUT-IO-AREA (126:6) TO PDATO-IO
               INSPECT PDATO-IO REPLACING ALL ' ' BY '0'
               MOVE INNPUT-IO-AREA (132:1) TO PTAKST (1:1)
               MOVE INNPUT-IO-AREA (133:4) TO PVEKT-IO
               INSPECT PVEKT-IO REPLACING ALL ' ' BY '0'
               MOVE INNPUT-IO-AREA (137:6) TO PPORTO-IO
               INSPECT PPORTO-IO REPLACING ALL ' ' BY '0'
               MOVE INNPUT-IO-AREA (150:1) TO STATUS-X (1:1)
               MOVE INNPUT-IO-AREA (151:30) TO VADR1 (1:30)
               MOVE INNPUT-IO-AREA (181:30) TO VADR2 (1:30)
               MOVE INNPUT-IO-AREA (211:27) TO VADR3 (1:27)
               MOVE INNPUT-IO-AREA (241:20) TO VADR4 (1:20)
           END-EVALUATE.
       ...
       INNPUT-CHK-LEVEL-P.
           ...
           WHEN ANY
               ...
               MOVE INNPUT-IO-AREA (1:3)   TO INNPUT-01-L2-FIRMA
               MOVE INNPUT-IO-AREA (10:6)  TO INNPUT-01-L1-KUNDNR
       ...
       DETAIL-OUTPUT-P.
           ...
           IF  (I-01 AND NOT-I-86)
               ...
               INITIALIZE LISTE-IO-AREA
               IF  (I-L1)
                   MOVE PNR                TO LISTE-IO-AREA (8:4)
               END-IF
               IF  (I-L1)
                   MOVE PSTED              TO LISTE-IO-AREA (13:15)
               END-IF
               MOVE VADR1                  TO LISTE-IO-AREA (39:30)
               INITIALIZE VADR1
               MOVE VADR3                  TO LISTE-IO-AREA (69:27)
               INITIALIZE VADR3
               MOVE ORDNR                  TO LISTE-IO-AREA (96:6)
               MOVE PDATO                  TO EDIT-DATE
               MOVE EDIT-DATE (7:8)        TO LISTE-IO-AREA (104:8)
               MOVE PVEKT                  TO XO-31YYZ
               MOVE XO-31YYZ               TO LISTE-IO-AREA (112:5)
               INITIALIZE PVEKT
               MOVE PPORTO                 TO XO-42YY9
               MOVE XO-42YY9               TO LISTE-IO-AREA (117:8)
               INITIALIZE PPORTO
               IF  (I-11)
                   MOVE 'BLÅ    '          TO LISTE-IO-AREA (126:7)
               END-IF
               IF  (I-12)
                   MOVE 'BLÅ-RØD'          TO LISTE-IO-AREA (126:7)
               END-IF
               IF  (I-13)
                   MOVE 'RØD    '          TO LISTE-IO-AREA (126:7)
               END-IF
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF.
       ...
       HEADING-OUTPUT-P.
           IF  (I-L2 AND NOT-I-86)
               ...
               MOVE LOPNVN                 TO LISTE-IO-AREA (31:35)
               ...
               MOVE 'NAVN'                 TO LISTE-IO-AREA (8:4)
               MOVE 'VARE ADRESSE 1'       TO LISTE-IO-AREA (39:14)
               MOVE 'VARE ADRESSE 3'       TO LISTE-IO-AREA (69:14)
               MOVE '        PAKKE    '    TO LISTE-IO-AREA (96:17)
               MOVE 'BEREGNET'             TO LISTE-IO-AREA (120:8)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'ADRESSE'              TO LISTE-IO-AREA (8:7)
               MOVE 'ORDRENR DATO     '    TO LISTE-IO-AREA (96:17)
               MOVE 'VEKT'                 TO LISTE-IO-AREA (113:4)
               MOVE 'PORTO'                TO LISTE-IO-AREA (120:5)
               MOVE 'TYPE   '              TO LISTE-IO-AREA (126:7)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
       ...
       TOTAL-OUTPUT-P.
           IF  (I-L2 AND NOT-I-86)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'TOTALT FOR FIRMA      ' TO LISTE-IO-AREA (79:22)
               MOVE FNRSUM                 TO XO-72YY9R
               MOVE XO-72YY9R              TO LISTE-IO-AREA (112:13)
               INITIALIZE FNRSUM
               MOVE 1                      TO LISTE-BEFORE-SPACE
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
