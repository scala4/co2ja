      ...
      * PROGRAM ORD604 ,UTPLUKK TIL DAGENS SALG MED BRF     *
      * MINDRE ENN XX PROSENT, LIK ORD600 MEN MED KUNDENAVN *
      * FJERNER OGSÅ KNR M/ 2,3 OG 5 I FØRSTE SIFFER        *
      * LESER SEQ ORDREFILE OG DANNER ORDRESUM RECORDS.     *
      *                                                     *
      * PROGR.  ELIN                                        *
      * DATO    26.08.09                                    *
      * 26.08.09 IKKE LAGEROVERF. KUNDENR=59XXXX            *
      * 17.11.09 IKKE KNR M/FØRSTESIFFER 2,3,5              *
      * 18.11.09 IKKE Varegruppe 99400 - Pant               *
      * 04.03.10 UTVIDET HJSUM TIL 11.2                     *
      *******************************************************
      *
      ...
      **************************************************************
           ...
           IF  (I-01)
               ...
               MOVE BK                     TO BK2
               MOVE KUNDNR                 TO KUNKUN
           END-IF
           IF  (NOT-I-04)
               GO TO SLUTT-T
           END-IF
           MOVE FIRMA                      TO KEY1 (1:3)
           MOVE KUNKUN                     TO KEY1 (4:6)
           MOVE KEY1                       TO KUNDEMA-KEY1
      ...
      *****************************************************************
       ...
       ORDSEQ-FLDSET-P.
           ...
           WHEN ( ORDSEQ-IO-AREA (1:1) = 'O'
            ...
            AND   ORDSEQ-IO-AREA (20:1) = '1' )
               ...
               MOVE ORDSEQ-IO-AREA (21:1)  TO KUND1F (1:1)
       ...
       KUNDEMA-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE KUNDEMA-IO-AREA (46:22) TO NAVN2 (1:22)
       ...
       DETAIL-OUTPUT-P.
           IF  (I-L2 AND NOT-I-86)
               ...
               MOVE 'BK SIGN.'             TO LISTE-IO-AREA (125:8)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
           ...
           AND (NOT-I-86)
               ...
               INITIALIZE BRF
               MOVE BK2                    TO LISTE-IO-AREA (126:1)
               INITIALIZE BK2
               MOVE SIGN-X                 TO LISTE-IO-AREA (129:2)
               INITIALIZE SIGN-X
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
               MOVE SPACES TO LISTE-IO-AREA
               ...
               INITIALIZE NAVN1
      *                        NAVN2  B  XX
               MOVE ADR                    TO LISTE-IO-AREA (48:30)
               INITIALIZE ADR
               MOVE PNR                    TO LISTE-IO-AREA (79:4)
               INITIALIZE PNR
               MOVE PSTED                  TO LISTE-IO-AREA (84:15)
               INITIALIZE PSTED
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF.
