       ...
       PROGRAM-ID. RKO021R.
      **********************************************  Z-WIN-RPG2   ****
      * NY VERSJON AV RSK.RSK021                 ***TXT***OK MT      *
      * KOPI AV PROGRAM LIGGER I FAK10A RKO.RKO121 *NB*   OK SS      *
      * HUSK Å RETTE RKO121 OGSÅ                   *NB*   OK SS      *
      ...
      *                        VTDUF    138
       ...
       TOTAL-OUTPUT-P.
           IF  (I-LR)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'AVSTEMMING PROG. RKO021 ' TO LISTE-IO-AREA (1:24)
