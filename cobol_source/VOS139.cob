      ...
      *
       ...
       FD SUMFILV
               ...
               RECORD CONTAINS 100.
       01  SUMFILV-IO-AREA.
           05  SUMFILV-IO-AREA-X           PICTURE X(100).
      ...
      *****************************************************************
       ...
       TOTAL-OUTPUT-P.
           IF  (I-L1 AND I-37)
               ...
               MOVE ORDNR                  TO SUMFILV-IO-AREA (4:6)
               MOVE KTSIFF                 TO SUMFILV-IO-AREA (10:1)
               MOVE AVD                    TO SUMFILV-IO-AREA (11:1)
               MOVE ORDATO-IO              TO SUMFILV-IO-AREA (12:6)
               MOVE KUNDNR                 TO SUMFILV-IO-AREA (18:6)
               MOVE KNAVN1                 TO SUMFILV-IO-AREA (24:30)
               MOVE ORDMOT                 TO SUMFILV-IO-AREA (54:2)
               MOVE STATUS-X               TO SUMFILV-IO-AREA (56:1)
               MOVE FIRSL2-IO              TO SUMFILV-IO-AREA (57:11)
               MOVE FIRAL2-IO              TO SUMFILV-IO-AREA (68:11)
               MOVE NULL11-IO              TO SUMFILV-IO-AREA (79:11)
               MOVE 'V'                    TO SUMFILV-IO-AREA (90:1)
               MOVE SKAF                   TO SUMFILV-IO-AREA (91:1)
