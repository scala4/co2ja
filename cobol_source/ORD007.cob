       ...
       PROGRAM-ID. ORD007R.
      **********************************************  Z-WIN-RPG2   ****
      * LISTE OVER ALLE KONTANTSALG-ORDRE, LAGE BRUDD KUNDENR.       *
      ****************************************************************
      *
      ...
      *
       ...
       01  WORK-AREA-BATCH.
           ...
           05  INNPUT-LEVEL-01.
               ...
               10  INNPUT-01-L1.
                   15  INNPUT-01-L1-KNR    PICTURE X(6).
       ...
       INNPUT-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE INNPUT-IO-AREA (19:6)  TO KNR (1:6)
               MOVE INNPUT-IO-AREA (19:5)  TO KNR5 (1:5)
           END-EVALUATE.
       ...
       INNPUT-CHK-LEVEL-P.
           ...
           WHEN ANY
               ...
               MOVE INNPUT-IO-AREA (19:6)  TO INNPUT-01-L1-KNR
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               ...
               MOVE REC                    TO OUTPUT-X-IO-AREA (1:100)
               IF  (I-10)
                   MOVE KNR                TO OUTPUT-X-IO-AREA (95:6)
               END-IF
               IF  (NOT-I-10)
                   MOVE '      '           TO OUTPUT-X-IO-AREA (95:6)
               END-IF
