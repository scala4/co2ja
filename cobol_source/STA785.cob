      ...
      *
       ...
       77  TABKUN-MAX   VALUE 50           PICTURE 9(4) USAGE BINARY.
       77  TABVRG-MAX   VALUE 150          PICTURE 9(4) USAGE BINARY.
       77  TABMND-MAX   VALUE 12           PICTURE 9(4) USAGE BINARY.
       77  TABEDB-MAX   VALUE 80           PICTURE 9(4) USAGE BINARY.
       77  TABKHN-MAX   VALUE 60           PICTURE 9(4) USAGE BINARY.
       01  TABLES.
           05  TABKUN-TABLE.
               10  TABKUN-ENTRY
                                           OCCURS 50 TIMES
      ...
      *
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01 AND I-20)
               ...
               END-IF
               IF  (I-18)
                   MOVE 'XXX'              TO OUTFILE-IO-AREA (83:3)
               END-IF
               IF  (I-18)
                   MOVE 'IKKE I VAREARKIV    ' TO OUTFILE-IO-AREA
                                                               (86:20)
               END-IF
