      ...
      *
       ...
       FILE-CONTROL.
           SELECT DIRKUND
               ASSIGN TO UT-S-DIRKUND
               ACCESS MODE IS SEQUENTIAL
               ORGANIZATION IS SEQUENTIAL
               STATUS IS DIRKUND-STATUS.
           SELECT ORDSUMF
       ...
       FD DIRKUND
               ...
               RECORD CONTAINS 9.
       01  DIRKUND-IO-AREA.
           05  DIRKUND-IO-AREA-X           PICTURE X(9).
       FD ORDSUMF
               BLOCK CONTAINS 200
               RECORD CONTAINS 100.
       01  ORDSUMF-IO-AREA.
       ...
       01  FILE-STATUS-TABLE.
           10  DIRKUND-STATUS              PICTURE 99 VALUE 0.
       ...
       01  WORK-AREA-BATCH.
           05  FILLER                      PIC X VALUE '0'.
               88  DIRKUND-EOF-OFF         VALUE '0'.
               88  DIRKUND-EOF             VALUE '1'.
           05  FILLER                      PIC X VALUE '0'.
               88  DIRKUND-READ-OFF        VALUE '0'.
               88  DIRKUND-READ            VALUE '1'.
           05  FILLER                      PIC X VALUE '0'.
               88  DIRKUND-PROCESS-OFF     VALUE '0'.
               88  DIRKUND-PROCESS         VALUE '1'.
           05  FILLER                      PIC X VALUE '1'.
               88  DIRKUND-LEVEL-INIT-OFF  VALUE '0'.
               88  DIRKUND-LEVEL-INIT      VALUE '1'.
           05  FILLER                      PIC X VALUE '0'.
           ...
           05  DIRKUND-LEVEL-01.
               10  DIRKUND-01-L2.
                   15  DIRKUND-01-L2-FIRMA PICTURE X(3).
               10  DIRKUND-01-L1.
                   15  DIRKUND-01-L1-KUNDE PICTURE X(6).
           05  DIRKUND-DATA-FIELDS.
               10  FIRMA                   PICTURE X(3).
               10  KUNDE                   PICTURE X(6).
           05  DIRKUND-MP                  PICTURE X(9).
           05  DIRKUND-MC                  PICTURE X(9).
           05  DIRKUND-M-01            REDEFINES DIRKUND-MC.
               10  DIRKUND-M-01-M2.
                   15  DIRKUND-M-01-M2-FIRMA-G.
                       20  DIRKUND-M-01-M2-FIRMA PICTURE X(3).
               10  DIRKUND-M-01-M1.
                   15  DIRKUND-M-01-M1-KUNDE-G.
                       20  DIRKUND-M-01-M1-KUNDE PICTURE X(6).
           05  ORDSUMF-LEVEL-02.
               10  ORDSUMF-02-L2.
           ...
           05  ORDSUMF-DATA-FIELDS.
               ...
               10  ANTVL-IO.
                   15  ANTVL               PICTURE S9(9) USAGE
                                                       PACKED-DECIMAL.
           05  ORDSUMF-MP                  PICTURE X(9).
           05  ORDSUMF-MC                  PICTURE X(9).
           05  ORDSUMF-M-02            REDEFINES ORDSUMF-MC.
               10  ORDSUMF-M-02-M2.
                   15  ORDSUMF-M-02-M2-FIRMA-G.
                       20  ORDSUMF-M-02-M2-FIRMA PICTURE X(3).
               10  ORDSUMF-M-02-M1.
                   15  ORDSUMF-M-02-M1-KUNDE-G.
                       20  ORDSUMF-M-02-M1-KUNDE PICTURE X(6).
       ...
       MAINLINE-LOOP.
           ...
           IF  DIRKUND-PROCESS
               SET DIRKUND-PROCESS-OFF     TO TRUE
               SET DIRKUND-READ            TO TRUE
           END-IF
 
           IF  DIRKUND-READ
               PERFORM DIRKUND-GET
               SET DIRKUND-READ-OFF        TO TRUE
               IF  NOT DIRKUND-EOF
                   PERFORM DIRKUND-MATCH-SET
               END-IF
           END-IF
      ...
      *****************************************************************
       ...
       DIRKUND-GET-P.
           IF  DIRKUND-EOF-OFF
               READ DIRKUND
               AT END
                   SET DIRKUND-EOF         TO TRUE
                   SUBTRACT 1            FROM LR-CHECK
               END-READ
           END-IF.
 
       DIRKUND-FLDSET SECTION.
       DIRKUND-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE DIRKUND-IO-AREA (1:3)  TO FIRMA (1:3)
               MOVE DIRKUND-IO-AREA (4:6)  TO KUNDE (1:6)
           END-EVALUATE.
 
       DIRKUND-IDSET SECTION.
       DIRKUND-IDSET-P.
           SET I-01                        TO TRUE.
 
       DIRKUND-CHK-LEVEL SECTION.
       DIRKUND-CHK-LEVEL-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE LOW-VALUES             TO DIRKUND-LEVEL-01
               MOVE DIRKUND-IO-AREA (1:3)  TO DIRKUND-01-L2-FIRMA
               MOVE DIRKUND-IO-AREA (4:6)  TO DIRKUND-01-L1-KUNDE
               IF  DIRKUND-LEVEL-INIT
                   EVALUATE TRUE
                   WHEN  DIRKUND-01-L2 NOT = THE-PRIOR-L2
                       PERFORM SETON-I-L2
                   WHEN  DIRKUND-01-L1 NOT = THE-PRIOR-L1
                       PERFORM SETON-I-L1
                   END-EVALUATE
               END-IF
               MOVE  DIRKUND-01-L2         TO THE-PRIOR-L2
               MOVE  DIRKUND-01-L1         TO THE-PRIOR-L1
               SET DIRKUND-LEVEL-INIT      TO TRUE
           END-EVALUATE.
 
       DIRKUND-MATCH-SET SECTION.
       DIRKUND-MATCH-SET-P.
           SET CALL-MATCH-RECS             TO TRUE
           EVALUATE TRUE
           WHEN ANY
               MOVE DIRKUND-IO-AREA (1:3)  TO DIRKUND-M-01-M2-FIRMA
               MOVE DIRKUND-IO-AREA (4:6)  TO DIRKUND-M-01-M1-KUNDE
           END-EVALUATE.
       ...
       ORDSUMF-MATCH-SET SECTION.
       ORDSUMF-MATCH-SET-P.
           SET CALL-MATCH-RECS             TO TRUE
           EVALUATE TRUE
           WHEN ANY
               MOVE ORDSUMF-IO-AREA (2:3)  TO ORDSUMF-M-02-M2-FIRMA
               MOVE ORDSUMF-IO-AREA (19:6) TO ORDSUMF-M-02-M1-KUNDE
           END-EVALUATE.
       ...
       MATCHING-RECORDS-P.
           IF  DIRKUND-EOF
               MOVE HIGH-VALUES            TO DIRKUND-MC
                                              DIRKUND-MP
           END-IF
           IF  ORDSUMF-EOF
               MOVE HIGH-VALUES            TO ORDSUMF-MC
                                              ORDSUMF-MP
           END-IF
           IF  DIRKUND-MC < DIRKUND-MP
               SET I-H0                    TO TRUE
               MOVE 'B'                    TO E-R-R-O-R
           END-IF
           IF  ORDSUMF-MC < ORDSUMF-MP
               SET I-H0                    TO TRUE
               MOVE 'B'                    TO E-R-R-O-R
           END-IF
           EVALUATE TRUE
           WHEN  DIRKUND-MC < ORDSUMF-MC
               IF  RECORD-SELECTED-OFF
                   SET RECORD-SELECTED     TO TRUE
                   SET DIRKUND-PROCESS     TO TRUE
                   MOVE DIRKUND-MC         TO DIRKUND-MP
                   IF  DIRKUND-MC = ORDSUMF-MP
                       SET SET-I-MR        TO TRUE
                   ELSE
                       SET NOT-SET-I-MR    TO TRUE
                   END-IF
               END-IF
           WHEN  ORDSUMF-MC < DIRKUND-MC
               IF  RECORD-SELECTED-OFF
                   SET RECORD-SELECTED     TO TRUE
                   SET ORDSUMF-PROCESS     TO TRUE
                   MOVE ORDSUMF-MC         TO ORDSUMF-MP
                   IF  ORDSUMF-MC = DIRKUND-MP
                       SET SET-I-MR        TO TRUE
                   ELSE
                       SET NOT-SET-I-MR    TO TRUE
                   END-IF
       ...
       INITIALIZATION-P.
           ...
           MOVE 3                          TO LR-CHECK
           SET DIRKUND-LEVEL-INIT          TO TRUE
           INITIALIZE DIRKUND-DATA-FIELDS
           SET DIRKUND-EOF-OFF             TO TRUE
           SET DIRKUND-PROCESS             TO TRUE
           MOVE LOW-VALUES                 TO DIRKUND-MC
                                              DIRKUND-MP
           OPEN INPUT DIRKUND
           SET ORDSUMF-LEVEL-INIT          TO TRUE
