       ...
       PROGRAM-ID. ORD712R.
      **********************************************  Z-WIN-RPG2   ****
      * DANNER I REST.RECORD FRA VARESETT/LØSE STRUKTURER  *
      * PROGRAMMER: ESPEN LARSEN  12.11.2005               *
      *    KODE V = VARESETT.                              *
      ...
      *
       ...
       FD VARSTVS
               ...
               RECORD CONTAINS 30.
       01  VARSTVS-IO-AREA.
           05  VARSTVS-IO-AREA-X           PICTURE X(30).
       FD LOSESET
               BLOCK CONTAINS 240
               RECORD CONTAINS 120.
       01  LOSESET-IO-AREA.
       ...
       FD VARSTAA
               ...
               RECORD CONTAINS 15.
       01  VARSTAA-IO-AREA.
           05  VARSTAA-IO-AREA-X           PICTURE X(15).
       FD TOTALER
               BLOCK CONTAINS 81
               RECORD CONTAINS 81.
       01  TOTALER-IO-PRINT.
      ...
      *****************************************************************
           ...
           END-IF
           IF  (I-02)
               MULTIPLY ANT BY ANTSTK  GIVING ANTBES
      *****************************************************************
      *   TOTAL RUTINE.                                               *
      *****************************************************************
           END-IF
      ...
      ******************************************************
       ...
       VARSTVS-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE VARSTVS-IO-AREA (1:3)  TO FIRMA (1:3)
               MOVE VARSTVS-IO-AREA (4:7)  TO EDBSET (1:7)
               MOVE VARSTVS-IO-AREA (16:1) TO SETTYP (1:1)
               MOVE VARSTVS-IO-AREA (11:4) TO ANT-IO
               MOVE VARSTVS-IO-AREA (1:15) TO REC01 (1:15)
               MOVE VARSTVS-IO-AREA (17:6) TO ORDNR (1:6)
               MOVE VARSTVS-IO-AREA (23:3) TO POSNR (1:3)
           END-EVALUATE.
       ...
       VARSTVS-CHK-LEVEL-P.
           ...
           WHEN ANY
               ...
               MOVE VARSTVS-IO-AREA (1:3)  TO VARSTVS-01-L3-FIRMA
               MOVE VARSTVS-IO-AREA (17:6) TO VARSTVS-01-L2-ORDNR
               MOVE VARSTVS-IO-AREA (23:3) TO VARSTVS-01-L1-POSNR
       ...
       VARSTVS-MATCH-SET-P.
           ...
           EVALUATE TRUE
           WHEN ANY
               MOVE VARSTVS-IO-AREA (1:3)  TO VARSTVS-M-01-M3-FIRMA
               MOVE VARSTVS-IO-AREA (17:6) TO VARSTVS-M-01-M2-ORDNR
               MOVE VARSTVS-IO-AREA (23:3) TO VARSTVS-M-01-M1-POSNR
           END-EVALUATE.
       ...
       LOSESET-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE LOSESET-IO-AREA (32:5) TO ANTSTK-IO
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-02 AND I-MR)
               ...
               MOVE REC01                  TO VARSTAA-IO-AREA (1:15)
               MOVE EDBVAR-IO              TO VARSTAA-IO-AREA (4:7)
               MOVE ANTBES                 TO XO-52P
               MOVE XO-52P-EF              TO VARSTAA-IO-AREA (11:4)
           ...
           IF  (I-01 AND I-U1)
               ...
               MOVE ANT                    TO XO-52YY9
               MOVE XO-52YY9               TO TOTALER-IO-AREA (29:9)
               IF  (I-MR)
           ...
           IF  (I-02 AND I-MR AND I-U1)
               ...
               MOVE ANTSTK                 TO XO-72YY9
               MOVE XO-72YY9               TO TOTALER-IO-AREA (26:12)
               MOVE '='                    TO TOTALER-IO-AREA (39:1)
               MOVE ANTBES                 TO XO-52YY9
               MOVE XO-52YY9               TO TOTALER-IO-AREA (41:9)
               MOVE 1                      TO TOTALER-AFTER-SPACE
               PERFORM TOTALER-PRINT-LINE
           END-IF.
       ...
       HEADING-OUTPUT-P.
           IF  (I-1P AND I-U1)
               ...
               MOVE ' DANNE I REST.REC. FRA ' TO TOTALER-IO-AREA
                                                               (12:23)
       ...
       TOTAL-OUTPUT-P.
           IF  (I-LR AND I-U1)
               ...
               MOVE XO-50YY9               TO TOTALER-IO-AREA (5:6)
               MOVE 'I REST.REC DANNET.     ' TO TOTALER-IO-AREA
                                                               (12:23)
