       ...
       PROGRAM-ID. FAK695R.
      **********************************************  Z-WIN-RPG2   ****
      * PROGRAM FAK693 AV STEIN SANDVOLD 26.08.2010                   *
      * DANNER NY FAKTURAFILE som skal sende ut ehf faktura           *
      *        OBS OBS OBS                                            *
      ...
      *
       ...
       FD FKREC2
               ...
               RECORD CONTAINS 242.
       01  FKREC2-IO-AREA.
           05  FKREC2-IO-AREA-X            PICTURE X(242).
       FD LISTE
               BLOCK CONTAINS 133
               RECORD CONTAINS 133.
       01  LISTE-IO-PRINT.
      ...
      * * END   RBS - PARAMETERKORT OVERSTYRING AV RBS-FILE  * *
           ...
           05  FIRMAF-DATA-FIELDS.
               ...
               10  FNAVN                   PICTURE X(12).
               10  FKONTO                  PICTURE X(11).
               10  FORG-IO.
                   15  FORG                PICTURE S9(9) USAGE
                                                       PACKED-DECIMAL.
           05  THE-PRIOR-LEVEL.
      ...
      ******************************************************
       ...
       KUNDEMX-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE KUNDEMX-IO-AREA (180:9) TO KORG (1:9)
       ...
       FIRMAF-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE FIRMAF-IO-AREA (8:12)  TO FNAVN (1:12)
               MOVE FIRMAF-IO-AREA (564:11) TO FKONTO (1:11)
               MOVE FIRMAF-IO-AREA (896:5) TO FORG-IO
           END-EVALUATE.
       ...
       HEADING-OUTPUT-P.
           IF  (I-L2 AND NOT-I-86)
               ...
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'KUNDENS ORG.NR.'      TO LISTE-IO-AREA (2:15)
               MOVE 'SELGERS ORG.NR.'      TO LISTE-IO-AREA (17:15)
               MOVE 'SELGERS NAVN   '      TO LISTE-IO-AREA (32:15)
               MOVE 'SELGERS KONTONR'      TO LISTE-IO-AREA (47:15)
               MOVE 'SELGERS PARTYID'      TO LISTE-IO-AREA (62:15)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
       ...
       TOTAL-OUTPUT-P.
           IF  (I-L1 AND I-60)
               ...
               MOVE 'FAKTURAXML@AUTODA'    TO FKREC2-IO-AREA (16:17)
               ...
               END-IF
               MOVE '   '                  TO FKREC2-IO-AREA (160:3)
               MOVE ORGN2                  TO FKREC2-IO-AREA (164:9)
               MOVE FORG                   TO XO-90U
               MOVE XO-90U (1:9)           TO FKREC2-IO-AREA (173:9)
               MOVE '   '                  TO FKREC2-IO-AREA (182:3)
               MOVE FNAVN                  TO FKREC2-IO-AREA (185:12)
               MOVE FKONTO                 TO FKREC2-IO-AREA (197:11)
               MOVE ' '                    TO FKREC2-IO-AREA (208:1)
               IF FORG < 0
                 MOVE FORG                 TO XO-90D
                 MOVE XO-90D (1:9)         TO FKREC2-IO-AREA (209:9)
               ELSE
                 MOVE FORG                 TO XO-90U
                 MOVE XO-90U (1:9)         TO FKREC2-IO-AREA (209:9)
               END-IF
               MOVE '   '                  TO FKREC2-IO-AREA (218:3)
               MOVE '                    ' TO FKREC2-IO-AREA (222:20)
               MOVE FPRTYP                 TO FKREC2-IO-AREA (242:1)
           ...
           IF  (I-L1 AND I-60 AND NOT-I-86)
               ...
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE ORGN2                  TO LISTE-IO-AREA (2:9)
               MOVE '   '                  TO LISTE-IO-AREA (11:3)
               IF FORG < 0
                 MOVE FORG                 TO XO-90D
                 MOVE XO-90D (1:9)         TO LISTE-IO-AREA (14:9)
               ELSE
                 MOVE FORG                 TO XO-90U
                 MOVE XO-90U (1:9)         TO LISTE-IO-AREA (14:9)
               END-IF
               MOVE '   '                  TO LISTE-IO-AREA (23:3)
               MOVE FNAVN                  TO LISTE-IO-AREA (26:12)
               MOVE FKONTO                 TO LISTE-IO-AREA (38:11)
               MOVE ' '                    TO LISTE-IO-AREA (49:1)
               IF FORG < 0
                 MOVE FORG                 TO XO-90D
                 MOVE XO-90D (1:9)         TO LISTE-IO-AREA (51:9)
               ELSE
                 MOVE FORG                 TO XO-90U
                 MOVE XO-90U (1:9)         TO LISTE-IO-AREA (51:9)
               END-IF
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF
