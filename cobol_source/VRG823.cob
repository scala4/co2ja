      ...
      ********************************************
      *  L1N10   FIRMA     COMP "959"                    55
      *  L1N10   FIRMA     COMP "529"                    55
      ********************************************
      *  SJEKKER FIRMANR, FOR SJEKK EDBNR        *
      ********************************************
      *  L1N10   FIRMA     COMP "959"                    12
           END-IF
           IF  (I-L1 AND NOT-I-10)
      ...
      *                        IPRIS 1  103
           ...
           IF  (I-02 AND I-MR AND NOT-I-41)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE REC2                   TO LISTE-IO-AREA (1:91)
               MOVE TEDB                   TO LISTE-IO-AREA (6:7)
               MOVE '**  FUNNET PÅ EDBTABELL ' TO LISTE-IO-AREA
                                                              (106:24)
               MOVE ' **'                  TO LISTE-IO-AREA (130:3)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           ...
           AND (NOT-I-43)
               ...
               INITIALIZE LISTE-IO-AREA
               MOVE REC2                   TO LISTE-IO-AREA (1:91)
               MOVE EDBNR                  TO LISTE-IO-AREA (6:7)
               MOVE '**  FUNNET PÅ VAREMAS   ' TO LISTE-IO-AREA
                                                              (106:24)
               MOVE ' **'                  TO LISTE-IO-AREA (130:3)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           ...
           AND (NOT-I-71)
               ...
               INITIALIZE LISTE-IO-AREA
               MOVE REC2                   TO LISTE-IO-AREA (1:91)
               MOVE NYNR-IO                TO LISTE-IO-AREA (6:7)
               MOVE '**  NY, IKKE FUNNET     ' TO LISTE-IO-AREA
                                                              (106:24)
               MOVE ' **'                  TO LISTE-IO-AREA (130:3)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
      ...
      *  MAF  T        L1N55
           ...
           IF  (I-LR)
               ...
               MOVE ' ANTALL SOM MATCHET ' TO LISTE-IO-AREA (11:20)
               MOVE ' EDBTABELL'           TO LISTE-IO-AREA (31:10)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE ANTNMR-IO              TO LISTE-IO-AREA (3:8)
               MOVE ' ANTALL SOM IKKE MAT' TO LISTE-IO-AREA (11:20)
               MOVE 'CHET      '           TO LISTE-IO-AREA (31:10)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF
           IF  (I-L1 AND I-11)
