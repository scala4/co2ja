      ...
      *
       ...
       FD SYSNRMA
               RECORD CONTAINS 132.
       01  SYSNRMA-IO-AREA.
           05  SYSNRMA-IO-AREA-X           PICTURE X(132).
       FD FIRMAF
       ...
       01  FILE-STATUS-TABLE.
           10  SYSNRMA-STATUS              PICTURE 99 VALUE 0.
           10  FIRMAF-STATUS               PICTURE 99 VALUE 0.
           10  TOTALER-STATUS              PICTURE 99 VALUE 0.
 
       01  WORK-AREA-BATCH.
           05  FILLER                      PIC X VALUE '0'.
               88  SYSNRMA-EOF-OFF         VALUE '0'.
               88  SYSNRMA-EOF             VALUE '1'.
           05  FILLER                      PIC X VALUE '0'.
               88  SYSNRMA-READ-OFF        VALUE '0'.
               88  SYSNRMA-READ            VALUE '1'.
           05  FILLER                      PIC X VALUE '0'.
               88  SYSNRMA-PROCESS-OFF     VALUE '0'.
               88  SYSNRMA-PROCESS         VALUE '1'.
           05  FILLER                      PIC X VALUE '1'.
               88  SYSNRMA-LEVEL-INIT-OFF  VALUE '0'.
               88  SYSNRMA-LEVEL-INIT      VALUE '1'.
           ...
           05  SYSNRMA-LEVEL-01.
               10  SYSNRMA-01-L1.
                   15  SYSNRMA-01-L1-FIRMA PICTURE X(3).
           05  SYSNRMA-DATA-FIELDS.
       ...
       MAINLINE-LOOP.
           ...
           IF  SYSNRMA-PROCESS
               SET SYSNRMA-PROCESS-OFF     TO TRUE
               SET SYSNRMA-READ            TO TRUE
           END-IF
 
           IF  SYSNRMA-READ
           AND RECORD-SELECTED-OFF
               PERFORM SYSNRMA-GET
               SET SYSNRMA-READ-OFF        TO TRUE
               IF  NOT SYSNRMA-EOF
                   SET SYSNRMA-PROCESS     TO TRUE
           ...
           IF  SYSNRMA-PROCESS
               PERFORM SYSNRMA-IDSET
           END-IF
 
           IF  SYSNRMA-PROCESS
               PERFORM SYSNRMA-CHK-LEVEL
           END-IF
       ...
       DETAIL-CALCS-P.
           ...
           IF  (I-01 AND I-97)
               SET I-10                    TO TRUE
           END-IF
           IF  (I-01 AND NOT-I-98 AND NOT-I-97)
               ADD 1                       TO ANTR
           END-IF
           IF  (I-01 AND I-97)
               OR  (I-01 AND I-98)
      ...
      ******************************************************
       ...
       SYSNRMA-GET-P.
           IF  SYSNRMA-EOF-OFF
               READ SYSNRMA
               AT END
                   SET SYSNRMA-EOF         TO TRUE
                   SUBTRACT 1            FROM LR-CHECK
               END-READ
           END-IF.
 
       SYSNRMA-FLDSET SECTION.
       SYSNRMA-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE SYSNRMA-IO-AREA (3:3)  TO FIRMA (1:3)
               MOVE SYSNRMA-IO-AREA (25:1) TO SLETT (1:1)
           END-EVALUATE.
 
       SYSNRMA-IDSET SECTION.
       SYSNRMA-IDSET-P.
           SET I-01                        TO TRUE.
 
       SYSNRMA-CHK-LEVEL SECTION.
       SYSNRMA-CHK-LEVEL-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE LOW-VALUES             TO SYSNRMA-LEVEL-01
               MOVE SYSNRMA-IO-AREA (3:3)  TO SYSNRMA-01-L1-FIRMA
               IF  SYSNRMA-LEVEL-INIT
                   EVALUATE TRUE
                   WHEN  SYSNRMA-01-L1 NOT = THE-PRIOR-L1
                       PERFORM SETON-I-L1
                   END-EVALUATE
               END-IF
               MOVE  SYSNRMA-01-L1         TO THE-PRIOR-L1
               SET SYSNRMA-LEVEL-INIT      TO TRUE
           END-EVALUATE.
       ...
       TOTAL-OUTPUT-P.
           IF  (I-LR)
               ...
               MOVE 'RECORDS PÅ SYSTEMNUMMER' TO TOTALER-IO-AREA
                                                               (12:23)
               MOVE '-FILE.'               TO TOTALER-IO-AREA (35:6)
       ...
       INITIALIZATION-P.
           ...
           MOVE 1                          TO LR-CHECK
           SET SYSNRMA-LEVEL-INIT          TO TRUE
           INITIALIZE SYSNRMA-DATA-FIELDS
           SET SYSNRMA-EOF-OFF             TO TRUE
           SET SYSNRMA-PROCESS             TO TRUE
           OPEN I-O SYSNRMA
