      ...
      *****************************************************************
       ...
       INNFIL-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE INNFIL-IO-AREA (201:100) TO REC2 (1:100)
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               ...
               MOVE REC2                   TO OUTFIL-IO-AREA (201:100)
               IF  (NOT-I-10)
                   MOVE KONTO-IO           TO OUTFIL-IO-AREA (134:4)
               END-IF
               IF  (I-10)
                   MOVE '3010'             TO OUTFIL-IO-AREA (134:4)
               END-IF
               IF  (I-11)
                   MOVE '3010'             TO OUTFIL-IO-AREA (134:4)
               END-IF
               IF  (I-12)
                   MOVE '5000'             TO OUTFIL-IO-AREA (134:4)
               END-IF
               IF  (I-10)
                   MOVE '*'                TO OUTFIL-IO-AREA (138:1)
               END-IF
               IF  (I-11)
                   MOVE '*'                TO OUTFIL-IO-AREA (138:1)
               END-IF
