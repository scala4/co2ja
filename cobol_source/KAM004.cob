      ...
      **************************************************************
           ...
           05  TEMPORARY-FIELDS.
               ...
               10  HJ4-IO.
                   15  HJ4                 PICTURE S9(4).
               10  HJDD-IO.
                   15  HJDD                PICTURE S9(2).
               10  HJAA-IO.
                   15  HJAA                PICTURE S9(2).
               10  HJDATO-IO.
                   15  HJDATO              PICTURE S9(6).
               10  HJDAT8                  PICTURE X(8).
               10  DAGDAT-IO.
                   15  DAGDAT              PICTURE S9(6).
      ...
      *
           ...
           IF  (I-01)
               ...
               MOVE TILDAT (5:2)           TO HJAA-IO
      *
           END-IF
           IF  (I-01)
               MOVE HJAA                   TO HJ4 (1:2)
               MOVE HJ4                    TO HJDATO (1:4)
               MOVE HJDD                   TO HJDATO-IO (5:2)
               MOVE 'B'                    TO DATOK
      ...
      *
           ...
           IF  (I-01)
               ...
               MOVE HJ4 (1:2)              TO HJDD
               MOVE UDATE (5:2)            TO HJAA-IO
      *
           END-IF
           IF  (I-01)
               MOVE HJAA                   TO HJ4 (1:2)
               MOVE HJ4                    TO DAGDAT (1:4)
               MOVE HJDD                   TO DAGDAT-IO (5:2)
               MOVE 'B'                    TO DATOK
      ...
      ******************************************************
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01 AND I-10 AND NOT-I-86)
               ...
               END-IF
               IF  (I-16)
                   MOVE 'IKKE I VAREARKIV' TO LISTE-IO-AREA (35:16)
               END-IF
               IF  (I-16)
                   MOVE 'EDBNR'            TO LISTE-IO-AREA (52:5)
               END-IF
               IF  (I-16)
                   MOVE EDB                TO XO-70YY9
                   MOVE XO-70YY9           TO LISTE-IO-AREA (56:9)
                   INITIALIZE EDB
               END-IF
       ...
       HEADING-OUTPUT-P.
           IF  (I-60 AND NOT-I-86)
               ...
               MOVE 'KAMPANJER SOM VIL BLI' TO LISTE-IO-AREA (33:21)
               MOVE 'FJERNET KOMMENDE HELG' TO LISTE-IO-AREA (55:21)
