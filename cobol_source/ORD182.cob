      ...
      *          FERDIM    COMP "*"                      17 FERDIGMELDTE
           ...
           IF  (NOT-I-04)
               GO TO SLUTT-T
      *****************************************************************
      * VARELINJESUM PR. ANT. LEVERT                                  *
      *****************************************************************
           END-IF
           MULTIPLY ORPRIS BY ANTLEV   GIVING SUMBEL
           MULTIPLY ORRAB1 BY SUMBEL   GIVING SUM1
           DIVIDE SUM1 BY 100          GIVING RABBEL ROUNDED
           SUBTRACT RABBEL                 FROM SUMBEL
           MULTIPLY ORRAB2 BY SUMBEL   GIVING SUM1
           DIVIDE SUM1 BY 100          GIVING RABBEL ROUNDED
           SUBTRACT RABBEL                 FROM SUMBEL
           MULTIPLY ORRAB3 BY SUMBEL   GIVING SUM1
           DIVIDE SUM1 BY 100          GIVING RABBEL ROUNDED
           SUBTRACT RABBEL                 FROM SUMBEL
           MULTIPLY PRITIL BY ANTLEV   GIVING SUMTIL
           ADD SUMTIL                      TO SUMBEL
           SET I-10                        TO TRUE.
      ...
      *                        OPRIMMX  101
               ...
               END-IF
               MOVE SUMBEL-IO              TO OUTPUT-X-IO-AREA (150:9)
               MOVE AAR                    TO OUTPUT-X-IO-AREA (161:2)
               MOVE MND                    TO OUTPUT-X-IO-AREA (163:2)
               MOVE DAG                    TO OUTPUT-X-IO-AREA (165:2)
      *                        UYEAR X  162
      *                        UMONTHX  164
      *                        UDAY  X  166
      *                                 166 "180212"
