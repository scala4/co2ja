       ...
       PROGRAM-ID. FAK004R.
      **********************************************  Z-WIN-RPG2   ****
      *      OVERFØRER FAKTURAOMGANGSNUMMER TIL SISTE FULLFØRTE       *
      *        FAKTURAOMGANG.                                         *
      *        DETTE BENYTTES AV PROGRAM ORD110 FOR Å FJERNE FERDIG   *
      *        FAKTURERTE ORDRE.                                      *
      *****************************************************************
      *
      ...
      *
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               MOVE FAKONR                 TO FAKPAR-IO-AREA (89:2)
               REWRITE FAKPAR-IO-AREA
           END-IF.
