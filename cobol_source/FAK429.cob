      ...
      **********************************************  Z-WIN-RPG2   ****
      *                                          XX2000XXIRXXMT      *
      *  OPPDATERE PERIODE PÅ GJENNOMFAKTURARECORDS.                 *
      *  DENNE PERIODE ER GRUNNLAG FOR UTPLUKK TIL FAKTURERING       *
      *  I PROGRAM FAK031 I JOB FAK10A.                              *
      *  OM RECORD IKKE MERGER SETTES INN DAGENS ÅR OG MND.          *
      * 07.02.05 ESPEN LARSEN                                        *
      ****************************************************************
      *
      ...
      *****************************************************************
       ...
       FAKTREC-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE FAKTREC-IO-AREA (198:3) TO FIRMA (1:3)
       ...
       FAKTREC-CHK-LEVEL-P.
           ...
           WHEN ANY
               ...
               MOVE FAKTREC-IO-AREA (198:3) TO FAKTREC-02-L2-FIRMA
       ...
       FAKTREC-MATCH-SET-P.
           ...
           EVALUATE TRUE
           WHEN ANY
               MOVE FAKTREC-IO-AREA (198:3) TO FAKTREC-M-02-M2-FIRMA
       ...
       DETAIL-OUTPUT-P.
           IF  (I-02)
               ...
               END-IF
               IF  (NOT-I-MR)
                   MOVE UYEAR              TO FAKTREC-IO-AREA (167:2)
               END-IF
               IF  (I-MR)
                   MOVE PERMND             TO FAKTREC-IO-AREA (169:2)
               END-IF
               IF  (NOT-I-MR)
                   MOVE UMONTH             TO FAKTREC-IO-AREA (169:2)
               END-IF
               MOVE '   '                  TO FAKTREC-IO-AREA (198:3)
      *****************************************************************
