      ...
      *
       ...
       01  WORK-AREA-BATCH.
           ...
           05  VAGRMAS-LEVEL-01.
               10  VAGRMAS-01-L1.
                   15  VAGRMAS-01-L1-FIRMA PICTURE X(3).
      ...
      ******************************************************
       ...
       VAGRMAS-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE VAGRMAS-IO-AREA (56:1) TO SLETT (1:1)
           END-EVALUATE.
       ...
       VAGRMAS-CHK-LEVEL-P.
           ...
           WHEN ANY
               ...
               MOVE VAGRMAS-IO-AREA (3:3)  TO VAGRMAS-01-L1-FIRMA
       ...
       TOTAL-OUTPUT-P.
           IF  (I-LR)
               ...
               MOVE 'RECORDS PÅ VAREGRPARKIV' TO TOTALER-IO-AREA
                                                               (12:23)
