       ...
       PROGRAM-ID. ALF110R.
      **********************************************  Z-WIN-RPG2   ****
      *   DANNER BESTALF- VSAM VAREGR-ALFA FILE                    *
      ****************************************************************
      *
      ...
      *
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               MOVE SPACES TO AFILE-IO-AREA
               INITIALIZE AFILE-IO-AREA
               MOVE 'A'                    TO AFILE-IO-AREA (1:1)
               MOVE FNR                    TO AFILE-IO-AREA (1:3)
               MOVE VGR                    TO AFILE-IO-AREA (4:5)
               MOVE ALF                    TO AFILE-IO-AREA (9:3)
               MOVE '00'                   TO AFILE-IO-AREA (12:2)
               MOVE '00'                   TO AFILE-IO-AREA (14:2)
               WRITE AFILE-IO-AREA
           END-IF.
