      ...
      ******************************************************
       ...
       RBSRUT-S-P.
           ...
           MOVE '000'                      TO LUNDGR
           MOVE 'NYB127  '                 TO LPROG
           MOVE BNAVN                      TO BMEMO (1:9)
           MOVE 0                          TO LANTX
           MOVE 'PRT1'                     TO LPRIID
      ...
      ******************************************************
       ...
       VARETIL-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE VARETIL-IO-AREA (13:20) TO LEVART (1:20)
           END-EVALUATE.
      ...
      *                        B         27
               MOVE LEVUKE                 TO LISTE-IO-AREA (24:2)
               MOVE LEVA-ELGR-IO           TO LISTE-IO-AREA (27:2)
               MOVE ALFA                   TO LISTE-IO-AREA (30:3)
               MOVE ARTNR                  TO LISTE-IO-AREA (34:20)
               IF  (NOT-I-50)
                   MOVE LEVART             TO LISTE-IO-AREA (55:20)
               END-IF
               MOVE EDBNR                  TO XO-70U
               MOVE XO-70U (1:7)           TO LISTE-IO-AREA (76:7)
               MOVE RAB1                   TO EDIT-RAB1
               MOVE EDIT-RAB1              TO LISTE-IO-AREA (84:4)
               MOVE RAB2                   TO EDIT-RAB2
               MOVE EDIT-RAB2              TO LISTE-IO-AREA (89:4)
      *                        VT        85
               IF  (NOT-I-06)
                   MOVE UPRIS              TO EDIT-UPRIS
                   MOVE EDIT-UPRIS         TO LISTE-IO-AREA (94:10)
               END-IF
               IF  (I-06)
                   MOVE SKOST              TO EDIT-SKOST
                   MOVE EDIT-SKOST         TO LISTE-IO-AREA (94:10)
               END-IF
               IF  (I-06 AND I-05)
                   MOVE '*'                TO LISTE-IO-AREA (104:1)
               END-IF
               MOVE BANT                   TO XO-70YNZ
               MOVE XO-70YNZ               TO LISTE-IO-AREA (105:7)
               IF  (NOT-I-11)
                   MOVE TANT               TO XO-70YNZ
                   MOVE XO-70YNZ           TO LISTE-IO-AREA (113:7)
               END-IF
               IF  (NOT-I-11)
                   MOVE TDAG               TO XO-20YNZ
                   MOVE XO-20YNZ           TO LISTE-IO-AREA (121:2)
               END-IF
               IF  (NOT-I-11)
                   MOVE TMND               TO LISTE-IO-AREA (124:2)
               END-IF
               IF  (NOT-I-11)
                   MOVE TA-ELGR            TO LISTE-IO-AREA (127:2)
               END-IF
               IF  (NOT-I-11)
                   MOVE '.'                TO LISTE-IO-AREA (123:1)
               END-IF
               IF  (NOT-I-11)
                   MOVE '.'                TO LISTE-IO-AREA (126:1)
               END-IF
               IF  (I-90)
                   MOVE 'B'                TO LISTE-IO-AREA (130:1)
               END-IF
               IF  (I-25)
       ...
       HEADING-OUTPUT-P.
           IF  (I-L2 AND I-60 AND NOT-I-86)
               ...
               MOVE 'OPPG=BES10'           TO LISTE-IO-AREA (71:10)
               ...
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'BEST  POS  BESTILL'   TO LISTE-IO-AREA (1:18)
               MOVE 'LEV'                  TO LISTE-IO-AREA (24:3)
               IF  (NOT-I-06)
                   MOVE 'PRIS'             TO LISTE-IO-AREA (95:4)
               END-IF
               IF  (I-06)
                   MOVE 'U'                TO LISTE-IO-AREA (103:1)
               END-IF
               MOVE ' BEST    TILG   TILGANG' TO LISTE-IO-AREA (105:23)
               MOVE 'IKKE'                 TO LISTE-IO-AREA (129:4)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'NR.   NR.  DATO    AVD' TO LISTE-IO-AREA (1:22)
               MOVE 'UKEÅR ALF'            TO LISTE-IO-AREA (24:9)
               MOVE 'ARTIKKELNUMMER'       TO LISTE-IO-AREA (34:14)
               MOVE 'LEVRANDØR ARTIKKELNR' TO LISTE-IO-AREA (55:20)
               MOVE 'EDB-NR. RAB. RAB.'    TO LISTE-IO-AREA (76:17)
               IF  (NOT-I-06)
                   MOVE 'UTL. MYNT'        TO LISTE-IO-AREA (95:9)
               END-IF
               IF  (I-06)
                   MOVE 'SVS.    S'        TO LISTE-IO-AREA (95:9)
               END-IF
               MOVE ' ANTALL  ANTALL DATO' TO LISTE-IO-AREA (105:20)
               MOVE 'ANK.'                 TO LISTE-IO-AREA (129:4)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
       ...
       TOTAL-OUTPUT-P.
           ...
           IF  (I-U8 AND I-LR)
               ...
               MOVE B                      TO LISTE-IO-AREA (129:2)
               MOVE FAB                    TO LISTE-IO-AREA (130:1)
               MOVE VT                     TO LISTE-IO-AREA (130:1)
               MOVE TDATO                  TO LISTE-IO-AREA (125:6)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF.
