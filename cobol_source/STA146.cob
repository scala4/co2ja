      ...
      **************************************************************
           ...
           05  INNPUT-LEVEL-04.
               ...
               10  INNPUT-04-L2.
                   15  INNPUT-04-L2-VGR    PICTURE X(5).
               10  INNPUT-04-L1.
                   15  INNPUT-04-L1-ORDRE  PICTURE S9(7) USAGE
                                                       PACKED-DECIMAL.
           ...
           05  TEMPORARY-FIELDS.
               ...
               10  KJSUM-IO.
                   15  KJSUM               PICTURE S9(9)V9(2).
               10  ORD1-IO.
                   15  ORD1                PICTURE S9(7).
               10  DATOO-IO.
                   15  DATOO               PICTURE S9(6).
               10  ANT1-IO.
      ...
      *************************************************************
           ...
           IF  (I-04)
               ...
               ADD ODATO TO ZERO       GIVING DATOO
      ...
      ******************************************************
       ...
       TOTAL-CALCS-P.
           ...
           IF  (I-L2 AND NOT-I-23)
               DIVIDE SUM4 BY KJSUM    GIVING RPROS
      *
           END-IF
           IF  (I-L3)
      ...
      ******************************************************
       ...
       INNPUT-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE INNPUT-IO-AREA (77:4)  TO ODATO-IO
       ...
       INNPUT-CHK-LEVEL-P.
           ...
           WHEN ANY
               ...
               MOVE INNPUT-IO-AREA (60:5)  TO INNPUT-04-L2-VGR
               MOVE INNPUT-IO-AREA (71:4)  TO INNPUT-04-L1-ORDRE
       ...
       DETAIL-OUTPUT-P.
           IF  (I-15 AND NOT-I-86)
               ...
               MOVE XO-70YN9               TO LISTE-IO-AREA (30:7)
               MOVE ANT1                   TO XO-52YY9R
               MOVE XO-52YY9R              TO LISTE-IO-AREA (43:10)
               MOVE PRIS                   TO XO-72YY9R
               MOVE XO-72YY9R              TO LISTE-IO-AREA (58:13)
               IF  (NOT-I-11)
                   MOVE RAB1               TO XO-21YY9
                   MOVE XO-21YY9           TO LISTE-IO-AREA (74:4)
               END-IF
               IF  (NOT-I-12)
                   MOVE RAB2               TO XO-21YY9
                   MOVE XO-21YY9           TO LISTE-IO-AREA (79:4)
               END-IF
               IF  (NOT-I-13)
                   MOVE RAB3               TO XO-21YY9
                   MOVE XO-21YY9           TO LISTE-IO-AREA (84:4)
               END-IF
               MOVE VGR                    TO LISTE-IO-AREA (89:5)
               MOVE KNR                    TO LISTE-IO-AREA (95:6)
               MOVE DATOO                  TO EDIT-DATE
       ...
       HEADING-OUTPUT-P.
           IF  (I-L3 AND NOT-I-86)
               ...
               MOVE 'HITTIL I ÅR'          TO LISTE-IO-AREA (67:11)
               ...
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'ALFA  ARTIKKELNUMMER' TO LISTE-IO-AREA (1:20)
               MOVE 'ORDRENR'              TO LISTE-IO-AREA (30:7)
               MOVE 'ANTALL LEV.'          TO LISTE-IO-AREA (42:11)
               MOVE 'ORDREPRIS'            TO LISTE-IO-AREA (62:9)
               MOVE 'RABATTER'             TO LISTE-IO-AREA (77:8)
               MOVE 'VGR.'                 TO LISTE-IO-AREA (89:4)
               MOVE 'KUNDENR'              TO LISTE-IO-AREA (94:7)
               MOVE 'BILAGSDATO'           TO LISTE-IO-AREA (103:10)
               MOVE 'SALG'                 TO LISTE-IO-AREA (115:4)
      ...
      *                        VGR       30
       ...
       TOTAL-OUTPUT-P.
           IF  (I-L2 AND I-16 AND NOT-I-86)
      *                                  24 "ANTALL VARELINJER="
      *                        KSUMVL3B  30
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'TOTALT FOR V,GR.='    TO LISTE-IO-AREA (37:17)
      *                        VGR    B  59
               MOVE KSUM1B                 TO XO-92YY9R
               MOVE XO-92YY9R              TO LISTE-IO-AREA (56:15)
               INITIALIZE KSUM1B
               MOVE KJSUM                  TO XO-92YY9R
               MOVE XO-92YY9R              TO LISTE-IO-AREA (113:15)
               MOVE RPROS                  TO XO-31YY9R
      ...
      *                        RPROS J  132
           ...
           IF  (I-L3 AND NOT-I-86)
               ...
               MOVE XO-50YN9               TO LISTE-IO-AREA (26:5)
               INITIALIZE SUMVL
               MOVE 'TOTALT NETTOBELØP='   TO LISTE-IO-AREA (36:18)
               MOVE SUM1B                  TO XO-92YY9R
               MOVE XO-92YY9R              TO LISTE-IO-AREA (61:15)
               INITIALIZE SUM1B
               MOVE KJSUM3                 TO XO-92YY9R
               MOVE XO-92YY9R              TO LISTE-IO-AREA (111:15)
               INITIALIZE KJSUM3
