      ...
      *
       ...
       FILE-CONTROL.
           ...
           SELECT FAKTREG
               ASSIGN TO UT-S-FAKTREG
               ACCESS MODE IS SEQUENTIAL
               ORGANIZATION IS SEQUENTIAL
               STATUS IS FAKTREG-STATUS.
       DATA DIVISION.
       FILE SECTION.
       FD NULLF
               BLOCK CONTAINS 200
               RECORD CONTAINS 100.
       01  NULLF-IO-AREA.
           05  NULLF-IO-AREA-X             PICTURE X(100).
       FD FAKTREG
               BLOCK CONTAINS 200
               RECORD CONTAINS 100.
       01  FAKTREG-IO-AREA.
           05  FAKTREG-IO-AREA-X           PICTURE X(100).
       WORKING-STORAGE SECTION.
       01  ACCEPT-COMMAND-LINE             PICTURE X(80).
       01  FILE-STATUS-TABLE.
           10  NULLF-STATUS                PICTURE 99 VALUE 0.
           10  FAKTREG-STATUS              PICTURE 99 VALUE 0.
       ...
       NULLF-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE NULLF-IO-AREA (1:100)  TO REC (1:100)
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-01)
               MOVE SPACES TO FAKTREG-IO-AREA
               INITIALIZE FAKTREG-IO-AREA
               MOVE REC                    TO FAKTREG-IO-AREA (1:100)
               WRITE FAKTREG-IO-AREA
           END-IF.
