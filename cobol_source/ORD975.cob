       ...
       PROGRAM-ID. ORD975R.
      **********************************************  Z-WIN-RPG2   ****
      *       O R D R E R U T I N E P R O G R A M   O R D 9 7 5       *
      *       -------------------------------------------------       *
      ...
      *****************************************************************
       ...
       KAJ2-T.
           ...
           IF  (NOT-I-21 AND I-31)
               MOVE SNR1                   TO SELGER
           END-IF
           IF  (NOT-I-21 AND I-32)
               MOVE SNR2                   TO SELGER
           END-IF
           IF  (NOT-I-21 AND I-33)
               MOVE SNR3                   TO SELGER
           END-IF
           IF  (NOT-I-21 AND I-34)
               MOVE SNR4                   TO SELGER
           END-IF
           IF  (NOT-I-21 AND I-35)
               MOVE SNR5                   TO SELGER
           END-IF
           IF  (NOT-I-21 AND I-36)
               MOVE SNR6                   TO SELGER
           END-IF
           IF  (NOT-I-21 AND I-37)
               MOVE SNR7                   TO SELGER
           END-IF
           IF  (NOT-I-21 AND I-38)
               MOVE SNR8                   TO SELGER
           END-IF
           IF  (NOT-I-21 AND I-39)
               MOVE SNR9                   TO SELGER
           END-IF
           IF  (I-L1 AND I-21)
               MOVE '000'                  TO SELGER
      ...
      *****************************************************************
       ...
       INNF-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE INNF-IO-AREA (11:5)    TO VGR (1:5)
               MOVE INNF-IO-AREA (11:1)    TO VG1 (1:1)
           END-EVALUATE.
       ...
       KUNDEMX-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE KUNDEMX-IO-AREA (108:3) TO SNR2 (1:3)
               MOVE KUNDEMX-IO-AREA (111:3) TO SNR3 (1:3)
               MOVE KUNDEMX-IO-AREA (114:3) TO SNR4 (1:3)
               MOVE KUNDEMX-IO-AREA (117:3) TO SNR5 (1:3)
               MOVE KUNDEMX-IO-AREA (120:3) TO SNR6 (1:3)
               MOVE KUNDEMX-IO-AREA (123:3) TO SNR7 (1:3)
               MOVE KUNDEMX-IO-AREA (126:3) TO SNR8 (1:3)
               MOVE KUNDEMX-IO-AREA (129:3) TO SNR9 (1:3)
           END-EVALUATE.
