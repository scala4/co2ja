       ...
       PROGRAM-ID. ADL022R.
      ******************************************* :   Z-WIN-RPG2   ****
      *  PROGRAM: ADL022                         XX2000XXIRXXMT *
      *  SANERING AV LONNSMASTER. VSA.LONNMAS                   *
      ***********************************************************
      *
      ...
      *
       ...
       01  WORK-AREA-BATCH.
           ...
           05  LONNMAS-LEVEL-01.
               10  LONNMAS-01-L1.
                   15  LONNMAS-01-L1-FIRMA PICTURE X(3).
           05  LONNMAS-DATA-FIELDS.
               10  FIRMA                   PICTURE X(3).
               10  SLETT                   PICTURE X(6).
      ...
      ******************************************************
       ...
       LONNMAS-FLDSET-P.
           EVALUATE TRUE
           WHEN ANY
               MOVE LONNMAS-IO-AREA (2:3)  TO FIRMA (1:3)
               MOVE LONNMAS-IO-AREA (135:6) TO SLETT (1:6)
           END-EVALUATE.
       ...
       LONNMAS-CHK-LEVEL-P.
           ...
           WHEN ANY
               ...
               MOVE LONNMAS-IO-AREA (2:3)  TO LONNMAS-01-L1-FIRMA
       ...
       TOTAL-OUTPUT-P.
           IF  (I-LR)
               ...
               MOVE 'RECORDS PÅ LØNNS.MASTER' TO TOTALER-IO-AREA
                                                               (12:23)
