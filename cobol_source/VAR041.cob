      ...
      *
       ...
       FD INNPUT
               ...
               RECORD CONTAINS 400.
       01  INNPUT-IO-AREA.
           05  INNPUT-IO-AREA-X            PICTURE X(400).
       FD OPPSMAS
               RECORD CONTAINS 30.
       01  OPPSMAS-IO-AREA.
      ...
      *  02                MOVE "   "     ALFA    3
       ...
       INNPUT-FLDSET-P.
           ...
           WHEN ANY
               ...
               MOVE INNPUT-IO-AREA (13:3)  TO ALF (1:3)
               MOVE INNPUT-IO-AREA (16:20) TO ORGART (1:20)
               MOVE INNPUT-IO-AREA (6:7)   TO EDBNR (1:7)
               MOVE INNPUT-IO-AREA (213:14) TO ART14 (1:14)
           END-EVALUATE.
       ...
       DETAIL-OUTPUT-P.
           IF  (I-02 AND I-11)
               ...
               MOVE EDBNR                  TO OUTPUT-X-IO-AREA (23:7)
           ...
           IF  (I-1P)
               ...
               MOVE 'EDBNR'                TO LISTE-IO-AREA (56:5)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF
           IF  (I-02 AND NOT-I-11)
               ...
               MOVE ALF                    TO LISTE-IO-AREA (47:3)
               MOVE ORGART                 TO LISTE-IO-AREA (26:20)
               MOVE EDB                    TO LISTE-IO-AREA (54:7)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF
           IF  (I-02 AND I-11)
               ...
               MOVE EDBNR                  TO LISTE-IO-AREA (54:7)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF.
