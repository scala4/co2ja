      ...
      *
       ...
       FD NYPRIS
               ...
               RECORD CONTAINS 80.
       01  NYPRIS-IO-AREA.
           05  NYPRIS-IO-AREA-X            PICTURE X(80).
       FD LISTE
               BLOCK CONTAINS 133
               RECORD CONTAINS 133.
       01  LISTE-IO-PRINT.
       ...
       TOTAL-OUTPUT-P.
           IF  (I-L1 AND I-45)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'ANTALL REFNR FJERNET' TO LISTE-IO-AREA (1:20)
               MOVE ANT                    TO XO-50YY9
               MOVE XO-50YY9               TO LISTE-IO-AREA (32:6)
               INITIALIZE ANT
               MOVE FIRMA                  TO LISTE-IO-AREA (40:3)
               MOVE REFNR                  TO LISTE-IO-AREA (46:5)
               MOVE DATO                   TO XO-70YNZ
           ...
           IF  (I-L2)
               MOVE SPACES TO LISTE-IO-AREA
               INITIALIZE LISTE-IO-AREA
               MOVE 'ANT. REFNR PÅ MASTER' TO LISTE-IO-AREA (1:20)
               MOVE ANTN                   TO XO-50YY9
               MOVE XO-50YY9               TO LISTE-IO-AREA (32:6)
               INITIALIZE ANTN
               MOVE FIRMA                  TO LISTE-IO-AREA (43:3)
               MOVE 1                      TO LISTE-AFTER-SPACE
               PERFORM LISTE-PRINT-LINE
           END-IF.
