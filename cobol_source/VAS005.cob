      ...
      *    23.01.002 FIRMA 915 HISTORIKK PR. LAGERSTED
      *    04.04.003 HUSK Å RETTE PROG. VAS105 VED ENDRING.
      *    26.04.005 ENDRE FIRMANR FRA 633 TIL 608 OM UPSI 1.
      *    24.01.08  FIRMA 938 HISTORIKK PR. LAGERSTED FJ IFLG. ØISTEIN
      **************************************************************
      *
      ...
      *          FIRMA     COMP "633"                    29  GIDSKEN
           ...
           IF  (I-33)
               GO TO SLUTT-T
      *  SE VAS105 I NESTE STEP.  SS
      *  33      ALF       COMP "VEN"                3333    ALFA
      *  33      ALF       COMP "GAB"                3333    ALFA
      *  33      LAGERK    COMP "13"                     34
      *  33N34   LAGERK    COMP "15"                     34
      ...
      *                   U1 29           4 "608"
       ...
       TOTAL-OUTPUT-P.
           IF  (I-LR)
               ...
               MOVE SPACES TO PRF-IO-AREA
               INITIALIZE PRF-IO-AREA
               MOVE '*** VAS005 ***  KJØRT' TO PRF-IO-AREA (12:21)
